...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">BELT MASTER &nbsp;</h3>
            ...
            <div class="box-body">
                <div class="form-group">
                  ...
                  <!--   <a onclick="deleteuser();" class="btn btn-danger">
                    ...
                    <a onclick="NewWindow('beltmas_search.php', 'mywin', '800', '700', 'yes', 'center');" class="btn btn-info btn-sm">
...
<script src="js/beltmas.js"></script>
