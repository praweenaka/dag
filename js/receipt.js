...
function chng_type()
{
    if ((document.getElementById('paytype').value == "Cash TT") || (document.getElementById('paytype').value == "J/Entry")) {
    ...
    if ((document.getElementById('paytype').value == "Cash")) {
        document.getElementById('accno').value = "120412";
        document.getElementById('accno').disabled = true;
    } else if ((document.getElementById('paytype').value == "Cheque")) {
        document.getElementById('accno').value = "120900";
        document.getElementById('accno').disabled = true;
    } else {
    ...
    if ((document.getElementById('paytype').value == "Cash TT") || (document.getElementById('paytype').value == "Cash") || (document.getElementById('paytype').value == "J/Entry")) {
        document.getElementById('cashtot').disabled = false;
    } else {
        document.getElementById('cashtot').disabled = true;
    }
}


function search_cust_ind(cdata)
{
...
function passcusresult_cash_rec_ind()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById('hiddencount').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.getElementById('inv_details').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
        //alert("ok");
...
function new_inv()
{
    ...
    document.getElementById('paytype').value = "Cheque";
    document.getElementById('dt').value = "";
    document.getElementById('salesrep').value = "01";
    document.getElementById('chqcollect').value = "01";
    document.getElementById('accno').disabled = true;
    document.getElementById('accno').value = "120900";
...
function addchq_cash_rec()
{
    ...
    if (document.getElementById('invno').value != "") {
        if (document.getElementById('chqno').value != "") {
            ...
            alert("Please insert cheque details !!!");
        }
    } else {
...
function calc_bal_cash(overdue, cash_pay_next, chq_pay, inv_balance, cash_pay, e)
{
    ...
    if ((isNaN(document.getElementById(overdue).value) == false) && (document.getElementById(overdue).value != "")) {
        overdue_v = parseFloat(document.getElementById(overdue).value);
    } else {
        overdue_v = 0;
    }
...
function calc_bal(overdue, chq_pay, inv_balance, chq_balance, chq_balance_next, cash_pay, i, e)
{
    ...
    //alert(overdue_v);
    //alert(inv_tot_pay_all);


    if (Number(overdue_v) >= Number(inv_tot_pay_all)) {
        tmp_inv_balance = Number(parseFloat(Math.round(overdue_v * 100) / 100).toFixed(2)) - Number(parseFloat(Math.round(chq_pay_v * 100) / 100).toFixed(2)) - Number(parseFloat(Math.round(cash_pay_v * 100) / 100).toFixed(2));
        document.getElementById(inv_balance).value = tmp_inv_balance.toFixed(2);

        tmp_chq_balance_next = Number(parseFloat(Math.round(document.getElementById(chq_balance).value * 100) / 100).toFixed(2)) - Number(parseFloat(Math.round(document.getElementById(chq_pay).value * 100) / 100).toFixed(2));
        document.getElementById(chq_balance_next).value = tmp_chq_balance_next.toFixed(2);
...
function utilization()
{
    if (document.getElementById('invno').value != "") {
        ...
        if (document.getElementById('cmd_utilization').value == 1) {
            ...
            //alert(txtpaytot+" "+txtoverpay+" "+chqtot+" "+cashtot);
            a = (txtpaytot + txtoverpay);
            var n1 = a.toPrecision(2);
            b = (chqtot + cashtot);
            var n2 = b.toPrecision(2);
            ...
            if (n1 != n2) {
                ...
                var url = 'receipt_data.php';
                var params = 'Command=utilization&invdate=' + document.getElementById('invdate').value;
                ...
                params = params + '&dt=' + document.getElementById('dt').value;
                ...
                while (mcount > i) {
                    ...
                    sdate = "sdate" + i;
                    if (isNaN(document.getElementById(chq_pay).value) == false) {
                        params = params + '&' + delidate + '=' + document.getElementById(delidate).innerHTML;
                        params = params + '&' + invno + '=' + document.getElementById(invno).innerHTML;
                        params = params + '&' + chq_pay + '=' + document.getElementById(chq_pay).value;
                        params = params + '&' + chq_balance + '=' + document.getElementById(chq_balance).value;
                        params = params + '&' + cash_pay + '=' + document.getElementById(cash_pay).value;
                        params = params + '&' + invval + '=' + document.getElementById(invval).innerHTML;
                        params = params + '&' + inv_balance + '=' + document.getElementById(inv_balance).value;
                        params = params + '&' + sdate + '=' + document.getElementById(sdate).innerHTML;
...
function save_crec()
{
    if (((document.getElementById('paytype').value == "Cash TT") && (document.getElementById('accno').value == "")) || (document.getElementById('paytype').value == "Cash") && (document.getElementById('accno').value == "")) {
//    if ((document.getElementById('paytype').value == "Cash TT") && (document.getElementById('accno').value == "")) {
        ...
        if (document.getElementById('invno').value != "") {
            if (document.getElementById("cmd_save").value == 1) {
                ...
                var url = 'receipt_data.php';
                var params = 'Command=save_crec&recno=' + document.getElementById('invno').value;
                ...
                params = params + '&acc_name=' + document.getElementById('acc_name').value;
                params = params + '&accno2=' + document.getElementById('accno2').value;
                params = params + '&acc_name2=' + document.getElementById('acc_name2').value;
                params = params + '&cashtot=' + document.getElementById('cashtot').value;
                params = params + '&chqtot=' + document.getElementById('chqtot').value;
                params = params + '&txtpaytot=' + document.getElementById('txtpaytot').value;
                params = params + '&txtoverpay=' + document.getElementById('txtoverpay').value;
                params = params + '&paytype=' + document.getElementById('paytype').value;
                params = params + '&mcount=' + document.getElementById('hiddencount').value;
                params = params + '&salesrep=' + document.getElementById('salesrep').value;
                params = params + '&chqcollect=' + document.getElementById('chqcollect').value;
                params = params + '&dt=' + document.getElementById('dt').value;
                params = params + '&ca_refno=' + document.getElementById('ca_refno').value;
                params = params + '&ledg_ref_no=' + document.getElementById('ledg_ref_no').value;
...
function result_save_crec()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("chq_rec_validity");
        var chq_rec_validity = XMLAddress1[0].childNodes[0].nodeValue;

        if (chq_rec_validity == "yes") {
            ...
            if (i == 0) {
                ...
                XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("msg_dup");
                document.getElementById('invno').value = recno;
...
//		document.getElementById('invno1').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        opener.document.form1.paytype.value = XMLAddress1[0].childNodes[0].nodeValue;

        //XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("TTDATE");
        //opener.document.form1.dt.value = XMLAddress1[0].childNodes[0].nodeValue;

        //XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("AC_REFNO");
        //opener.document.form1.ca_refno.value = XMLAddress1[0].childNodes[0].nodeValue;
