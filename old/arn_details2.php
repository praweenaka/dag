...
<fieldset>
                                                	<legend>
  <div class="text_forheader">ARN2 Details</div>
                                               	 </legend>             
...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="16%"><input type="text" name="invno" id="invno" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);"  />
      <a href="serach_arn2.php" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
    ...
    <td width="20%"><input type="text"  name="invdate" id="invdate" value="<?php echo date("Y-m-d"); ?>" disabled="disabled" class="text_purchase3"/></td>
    <td width="1%">&nbsp;</td>
    <td width="0%">&nbsp;</td>
    <td width="0%">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="20%"><input type="text" name="orderno1" id="orderno1" value="" onkeypress="keyset('orderdate',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input type="text" disabled="disabled" class="text_purchase3" name="supplier_code" id="supplier_code"/>
...
<table>
  ...
  <tr>
    ...
    <td width="10%"><font color="#FFFFFF">
      <input type="text" size="20" name="total_value" id="total_value" value="" onblur="calc1();" class="text_purchase3" onkeypress="keyset('discount',event);"/>
    </font></td>
    </tr>
</table>
