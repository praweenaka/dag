...
<div class="text_forheader">Assign Privileges</div>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td width="9%"><input type="text"  class="label_purchase" value="Sample User" disabled="disabled"/></td>
    <td width="19%"><input type="text"  onblur="sampleuser();" class="text_purchase3"  id="sam_user" name="sam_user"  /></td> 
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
