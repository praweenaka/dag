...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="10%"><input type="text"  class="label_purchase" value="Active" disabled="disabled"/></td>
    <td width="17%"><input type="text"  class="label_purchase" value="Target Type" disabled="disabled"/></td>
    <td width="25%"><input type="text"  class="label_purchase" value="Group" disabled="disabled"/></td>
    <td width="29%"><input type="text"  class="label_purchase" value="Discount" disabled="disabled"/></td>
  </tr>
  <tr>
    ...
    <td><input type="text" class="text_purchase3"  id="group" name="group" onkeypress="keyset('class', event);" onKeyUp="ajax_showOptionsfname(this,'getCountriesByLetters',event,'ajax-list-brand.php');" onblur="setbrand();"/></td>
     <td><input type="number" class="text_purchase3"  id="dis" name="dis" onkeypress="keyset('class', event);"   /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
                              ...
                              <td width=\"424\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Class</font></td>
							   <td width=\"424\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Active</font></td>
								...
								<td width=\"424\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Discount</font></td>
										...
										$sql="select * from brand_mas order by act desc,class, barnd_name";
										$result =mysqli_query($GLOBALS['dbinv'],$sql) ; 	
										while ($row = mysqli_fetch_array($result)){
											if ($row["barnd_name"]!=""){
											echo "<tr>
											...
											if ($row["delinrate"]=="0"){
                                            	...
                                            	echo"<td width=\"150\" onclick=\"bankno('".$row['barnd_name']."', '".$row['class']."', '".$row['act']."', '".$row['delinrate']."','".$row['costcenter']."','".$row['dis']."');\">".$target."</td>
