...
<fieldset>
	...
	<form name="form1" id="form1">
		...
		<td><input type="text" class="text_purchase3" name="cuscode" id="cuscode" onblur="search_cust_ind();" onkeypress="keyset('salesrep',event);"/></td>
		<td colspan="2"> <input type="text"  class="text_purchase3" id="cusname" name="cusname" />
		...
		<td colspan="3"><input type="text"  class="text_purchase3"  id="cus_address" name="cus_address" /></td>
		<td>&nbsp;</td>
		<td><input type="text"  class="label_purchase" value="Entry Date" disabled="disabled"/></td>
		<td width="144"><input type="text" size="20" name="invdate" id="invdate" disabled="disabled" value="<?php echo date("Y-m-d"); ?>" onfocus="load_calader('invdate')"  class="text_purchase3"/></td>
		<td width="144"><input type="text"  class="label_purchase" value="Cost Center" disabled="disabled"/></td>
		<td width="105"><select name="costcenter" id="costcenter"  class="text_purchase3">
		<?php
		for ($i = 1; $i < 51; $i++) {
		...
		<td><input type="text" class="text_purchase3" name="ca_refno" id="ca_refno" /></td>
		<td><font color="#FFFFFF"><font color="#FFFFFF"><font color="#FFFFFF"><a href="search_unknown.php?stname=cash_rec2" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
		<input type="button" name="additem_tmp4" id="additem_tmp4" value="Select TT" class="btn_purchase1" />
		</a></font></font></font></td>
		<td><input type="text" class="text_purchase3" name="ledg_ref_no" id="ledg_ref_no" /></td>
		</tr>
		<tr>
		<td><a href="search_grn.php?stname=grn" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
		<input type="text"  class="label_purchase" value="Debit Account" disabled="disabled"/>
		</a></td>
		<td colspan="3"><a href="search_grn.php?stname=grn" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()"><font color="#FFFFFF"><font color="#FFFFFF">

		</font></font></a><font color="#FFFFFF"><font color="#FFFFFF"><font color="#FFFFFF">
		<select name="accno" id="accno" onkeypress="keyset('dte_dor',event);" onchange="setord();" class="text_purchase3">
		<option value=''></option>
		<?php
		...
		<input type="hidden"  class="text_purchase3" size="10" id="acc_name" name="acc_name" value="" onkeypress="keyset('bank',event);" />
		</font></font></font></td>
		<td><font color="#FFFFFF"><font color="#FFFFFF"></font></font></td>
		<td>
		...
		<table width="600" border="0">
			...
			<tr>
				...
				<td><font color="#FFFFFF">
					...
					?></font></td>
				<td><font color="#FFFFFF">
					<input type="text" size="15" name="bank" id="bank" value="" class="text_purchase3" onblur="get_bank();" onkeypress="eyset('chqamt',event);"/>
				...
				<td width="2%">
				<input type="button" name="additem_tmp" id="additem_tmp" value="Add" onclick="addchq_cash_rec();" class="btn_purchase1" />
				</td>
			</tr>
		</table>
...
<tr>
	...
	<table width="615" border="0">
		<tr>
			<td width="144">
			<input type="text"  class="label_purchase" value="Cheque Total" disabled="disabled"/>
			</td>
			<td width="127">
			<input type="text" size="20" name="chqtot" id="chqtot" value="" disabled="disabled" class="text_purchase3"/>
			</td>
			<td width="58">&nbsp;</td>
			<td width="144">
			<input type="text"  class="label_purchase" value="Cash Total" disabled="disabled"/>
			</td>
			<td width="120">
			<input type="text" size="20" name="cashtot" id="cashtot" value="" class="text_purchase3"/>
			</td>
		</tr>
	</table></th>
	<th scope="col" valign="top">
	<input type="button"  class="sell_search1" name="idcopy2" id="idcopy2" value="Display Image 1" onclick="NewWindow1('display_image.php?cou=image1','mywin','900','800','yes','center');return false" />
	<input type="button"  class="sell_search1" name="idcopy" id="idcopy" value="Display Image 2" onclick="NewWindow1('display_image.php?cou=image2','mywin','900','800','yes','center');return false" />
	<input type="button"  class="sell_search1" name="idcopy3" id="idcopy3" value="Display Image 3" onclick="NewWindow1('display_image.php?cou=image3','mywin','900','800','yes','center');return false" />
	</th>
</tr>
</table>
...
<fieldset>
	...
	<table width="84%" border="0">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>
			<input type="text"  class="label_purchase" value="Selected Invoice Amount" disabled="disabled"/>
			</td>
			<td>
			<input type="text" size="20" name="txtpaytot" id="txtpaytot" value="" disabled="disabled" class="text_purchase3"/>
			</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			...
			<td width="21%">&nbsp;</td>
			<td width="17%">
			<input type="text"  class="label_purchase" value="Over Payment" disabled="disabled"/>
			</td>
			<td width="17%">
			<input type="text" size="20" name="txtoverpay" id="txtoverpay" value="" disabled="disabled" class="text_purchase3"/>
			</td>
			<td width="11%">&nbsp;</td>
			<td width="1%">&nbsp;</td>
		</tr>
