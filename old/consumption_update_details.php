...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Consumtion Update</div>
                                               	 </legend>             
...
<form name="form1" id="form1">            
  ...
  <tr>
    <td><input type="text"  class="text_purchase3"  id="Text1" name="Text1" /></td>
    <td><input type="text"  class="text_purchase3"  id="Text2" name="Text2" /></td>
  ...
  <fieldset><div class="text_forheader"></div></legend>
</fieldset>    
