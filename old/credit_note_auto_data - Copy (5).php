...
//$ResponseXML .= "<tr><tr>ddddd</td></tr>";			
                        ...
                        $m_flag = date("m/Y", strtotime($_GET["dte_dor"])) . "/LF/" . $row["cus_code"] ;
...
//echo $sql;	
        while ($row = mysqli_fetch_array($result)) {
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != 0 and DIS_P != 100 and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
            ...
            $sql_1_40 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '35' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_1_40 = mysqli_query($GLOBALS['dbinv'], $sql_1_40);

            $sql_1_43 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P <> '35' AND DIS_P <> '37.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
            ...
            $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where  c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '37.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
...
//echo $sql;	
        while ($row = mysqli_fetch_array($result)) {
            ...
            $sql_1_43 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P <> '32.5' AND DIS_P <> '35' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
            ...
            $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '32.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
            $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
    ...
    if (trim($_GET["combo1"]) == "CONSTANCY") {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($mqty >= 10) {
                ...
                $sql_1_40 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != '0' and DIS_P != '100' and  SDATE>='" . $_GET["dtfrom"] . "' and SDATE<='" . $_GET["dtto"] . "'  and dis_p != '37.5' and CANCELL='0' ";
                $result_1_40 = mysqli_query($GLOBALS['dbinv'], $sql_1_40);

                $sql_1_43 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != '0' and DIS_P != '100' and  SDATE>='" . $_GET["dtfrom"] . "' and SDATE<='" . $_GET["dtto"] . "' and dis_p != '37.5' and CANCELL='0' ";
                $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
...
//echo "1-".$sql_tmp."</br>";
    ...
    if (trim($_GET["combo1"]) == "COOPER") {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where DIS_p !=100 and DIS_p !=0 and C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and   month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
            ...
            if ($mqty >= 15) {
                ...
                $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where costcenter ='0' and c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '37.5' and   SDATE>='" . $_GET["dtfrom"] . "' and SDATE<='" . $_GET["dtto"] . "' and CANCELL='0' ";
                $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ($mqty >= 6) {
                ...
                if ($mqty>= 6) {
                    ...
                    $m_flag = date("m/Y", strtotime($_GET["dte_dor"])) . "/GS/".$row["cus_code"] ;
...
//echo $sql;			
        while ($row = mysqli_fetch_array($result)) {
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != 0 and dis_p !=100 and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' group by C_CODE";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='ROADSTONE CHINA' and DIS_P != 0 and dis_p !=100 and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' group by C_CODE";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
            ...
            $sql_1_40 = "Select C_CODE1, sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and (DIS_P = 45 or dis_p = 47.5) and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and DIS_P != 0 and CANCELL='0' group by C_CODE";
            $result_1_40 = mysqli_query($GLOBALS['dbinv'], $sql_1_40);

            $sql_1_43 = "Select C_CODE1, sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and (DIS_P != 45 and dis_p != 47.5) and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and DIS_P != 0 and CANCELL='0' group by C_CODE";
            $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
            ...
            if ($row_rsven = mysqli_fetch_array($result_rsven)) {
                ...
                if ($mqty >= 200) {
                    ...
                    if ($row_rs1 = mysqli_fetch_array($result_rs1)) {
                        ...
                        $ResponseXML .= "<td>Not Saved</td>
												   <td></td>
												   <td>" . number_format((($amount_40 - $RTn) / 100) * 7.5, 2, ".", ",") . "</td>
												   <td>" . number_format((($amount_40_C - $rtn_c) / 100) * 7.5, 2, ".", ",") . "</td>
												   <td></td>
												   <td><input type=\"checkbox\" name=\"" . $chk . "\" id=\"" . $chk . "\" onclick=\"changechk('" . $i . "', '" . $code . "');\"  /></td>";

                        $crnno = "Not Saved";
                        $txndate = "";
                        $amount = (($amount_40 - $RTn) / 100) * 7.5;
                        $amount_c = (($amount_40_C - $rtn_c) / 100) * 7.5;
                        $status = "";
    ...
    if (trim($_GET["combo1"]) == "PRESA") {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ( $mqty >= 1) {
                ...
                $sql_1_40 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '40' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and DIS_P !=0  and CANCELL='0' ";
                $result_1_40 = mysqli_query($GLOBALS['dbinv'], $sql_1_40);

                $sql_1_43 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != '40' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "'  and DIS_P !=0  and CANCELL='0' ";
                $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
                ...
                $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '42.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  and DIS_P !=0  ";
                $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
                ...
                $sql_1_40 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '35' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND GROUP1 = '1000' ";
                $result_1_40 = mysqli_query($GLOBALS['dbinv'], $sql_1_40);
                ...
                $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '37.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND GROUP1 = '1000'  and DIS_P !=0  ";
                $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where DIS_p !=100 and DIS_p !=0 and C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and   month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' AND GROUP1 = '1000'";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
                ...
                if (($mqty>= 10) and ($mtotqty<25)) {
                    ...
                    $comm1 = $comm1 + ((($amount_40 - $rtn_40) / 60 * 3));
                    $gcomm2 = 0;
                }
...
//echo "1-".$sql_tmp."</br>";
    ...
    if (trim($_GET["combo1"]) == "WILLFLY") {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != 0  and dis_p != 100 and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND STK_NO <> 'A0350' AND STK_NO <> 'A0351' AND STK_NO <> 'A0352' AND STK_NO <> 'A0353' AND STK_NO <> 'A0354' AND STK_NO <> 'A0356' AND STK_NO <> 'AL001' AND STK_NO <> 'AL002' AND STK_NO <> 'AL003' and stk_no <>'A0359'  ";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
    ...
    if (trim($_GET["combo1"]) == "AGATE") {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            if ( $mqty  >= 10) {
                ...
                $sql_1_43 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != '35' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0' ";
                $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
                ...
                $sql_1_43 = "Select sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != '35' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND GROUP1 = '1000'  ";
                $result_1_43 = mysqli_query($GLOBALS['dbinv'], $sql_1_43);
                ...
                $sql_1_37 = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where c_code1='" . trim($row["cus_code"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P = '37.5' and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND GROUP1 = '1000'";
                $result_1_37 = mysqli_query($GLOBALS['dbinv'], $sql_1_37);
            ...
            $sql = "Select  sum(qty) as qty, sum((s_price * qty) * ((100 - DIS_P)/100)) as grand_tot from viewcrntrn where C_CODE='" . trim($row["cus_code1"]) . "' and   Brand='" . trim($_GET["combo1"]) . "' and DIS_P != 0  and dis_p != 100 and  month(SDATE)='" . date("m", strtotime($_GET["dte_dor"])) . "' and year(SDATE)='" . date("Y", strtotime($_GET["dte_dor"])) . "' and CANCELL='0'  AND GROUP1 = '1000' ";
            $result_m = mysqli_query($GLOBALS['dbinv'], $sql);
            if ($row_m = mysqli_fetch_array($result_m)) {
                $mqty = $mqty - $row_m['qty'];
            }
            ...
            if ($row_tmp["amount_c"] > 0) {
                for ($X = 1; $X <= 2; $X++) {
					...
					if (trim($_GET["combo1"]) == "LONGLIFE") {
                        ...
                        $m_flag = date("m/Y", strtotime($_GET["dte_dor"])) . "/LF/" . trim($row_tmp['code1']);
                    }
...
//==============update credit limit==========================================
				...
				if (trim($_GET["combo1"]) == "LONGLIFE") {
						...
						$txt_remark = "Additional 5%/2.5% Trade Discount for LONGLIFE - month of " . date("m/Y", strtotime($_GET["dte_dor"]));
                        $result_RSINVO = mysqli_query($GLOBALS['dbinv'], $sql_RSINVO);
                        $row_RSINVO = mysqli_fetch_array($result_RSINVO);
                ...
                if (trim($_GET["combo1"]) == "COOPER") {
				 ...
				 if (trim($_GET["combo1"]) == "GOALSTAR") {
					...
					$txt_remark = "Additional 5%/2.5% Trade Discount for GOALSTAR - month of " . date("m/Y", strtotime($_GET["dte_dor"]));	
                    $result_RSINVO = mysqli_query($GLOBALS['dbinv'], $sql_RSINVO);
                    $row_RSINVO = mysqli_fetch_array($result_RSINVO);

                    $m_flag = date("m/Y", strtotime($_GET["dte_dor"])) . "/GS/" . trim($row_tmp['code1']) ;
                }
