...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <?php
		...
		$sql = "select * from userpermission where username = '" . $_SESSION["CURRENT_USER"] . "' and docid = '19' and doc_view = '1' and doc_feed = '1'";
		$result =mysqli_query($GLOBALS['dbinv'],$sql) ; 
  ...
  <tr>
    ...
    <td colspan="3"><select name="Com_rep" id="Com_rep" onkeypress="keyset('dte_dor',event);" onchange="new_inv();" class="text_purchase3">
      <?php
		require_once("connectioni.php");
                if ($_SESSION["MANAGER"]!="") { 			 						
