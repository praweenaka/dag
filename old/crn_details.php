...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="crnno" id="crnno" disabled value="" class="text_purchase" onkeypress="keyset('searchcust',event);" onfocus="got_focus('invno');"  onblur="lost_focus('invno');"  />
    ...
    <td width="15%"><input type="text"  name="crndate" id="crndate" value="<?php echo date("Y-m-d"); ?>"  class="text_purchase2"/></td>
  ...
  <tr>
    ...
    <td><input type="text" name="invno" id="invno" disabled value="" onkeypress="keyset('orderdate',event);" class="text_purchase3"/>
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="inv_date" id="inv_date" disabled value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <input type = "hidden" id="c_subcode" >
...
require_once("connectioni.php");
    ...
    <td><input type="text" size="15" name="invamount" id="invamount" disabled value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="totpay" disabled id="totpay" value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input type="text" size="15" name="invbal" id="invbal" value="" disabled onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="settled" id="settled" disabled value="" onkeypress="keyset('creditlimit',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td>
	  <div style="visibility:hidden;" id="auth">
		<a onclick="NewWindow('autho.php?stname=crn','mywin','500','200','yes','center');return false" onfocus="this.blur()">
			<input name="searchcust7" id="searchcust7" value="Authorize" class="btn_purchase1" type="button">
		</a>
	  </div>
	</td>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    <td></td>
    <td  colspan="2">
	  <div style="visibility:hidden;" id="remk">
		<textarea id="remarkk" rows='10' cols='30'></textarea>
		
		<a onclick="p_remk();" onfocus="this.blur()">
			<input name="searchcust7" id="searchcust7" value="Update Remark" class="btn_purchase1" type="button">
		</a>
	  </div>
	</td>
    <td>&nbsp;</td>
