			...
			while($row = mysql_fetch_array($result)){	
				...
				$subtotal="subtotal".$i;
             	...
             	$ResponseXML .= "<tr>                              
							 ...
							 <td bgcolor=\"#222222\" ><input type=\"text\" size=\"15\" name=".$selling." id=".$selling." onBlur=\"cal_margine('".$i."', '".$mcou."');\"  class=\"txtbox\"/></td>
		...
		if ($row = mysql_fetch_array($result)){
			...
			while($row = mysql_fetch_array($result)){	
				...
				if (is_null(trim($row['COST'])) ==false){
             	...
             	$ResponseXML .= "<tr>     
							<td ><input type=\"text\" size=\"0\" name=".$qtyinhand." id=".$qtyinhand."   value='".$row['QTYINHAND']."' class=\"txtbox\" disabled=\"disabled\"/></td>                         
                             <td ><input type=\"text\" size=\"15\" name=".$itemcode." id=".$itemcode."   value='".$row['STK_NO']."' class=\"txtbox\" disabled=\"disabled\"/></td>
							  <td ><input type=\"text\" size=\"15\" name=".$itemname." id=".$itemname."  value='".$row['DESCRIPT']."' class=\"txtbox\" disabled=\"disabled\"/></td>
							  <td  ><input type=\"text\" size=\"15\" name=".$ord_qty." id=".$ord_qty."  value='".$row['O_QTY']."' class=\"txtbox\" disabled=\"disabled\"/></td>
							
							 <td ><input type=\"text\" size=\"15\" name=".$fob." id=".$fob." value='".$row['FOB']."'  class=\"txtbox\"  disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$qty." id=".$qty." value='".$row['REC_QTY']."'  class=\"txtbox\"  disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$acc_cost." id=".$acc_cost." value='".$row['acc_cost']."'  class=\"txtbox\"  disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$selling." id=".$selling." value='".$row['SELLING']."'  class=\"txtbox\" disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$margin." id=".$margin." value='".$row['MARGIN']."'  class=\"txtbox\" disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$subtotal." id=".$subtotal." value='".$row['COST']*$row['REC_QTY']."'  class=\"txtbox\" disabled=\"disabled\"/></td>
							 <td ><input type=\"text\" size=\"15\" name=".$cost." id=".$cost." value=\"".$COST_val."\"  class=\"txtbox\" onBlur=\"cal_sub('".$i."', '".$mcou."');\"  /></td>
							</tr>";
