...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="14%"><input type="text" name="invno" id="invno" value="" class="text_purchase" onkeypress="keyset('searchcust',event);"  />
    ...
    <td width="16%"><input type="text"  name="invdate" id="invdate" value="<?php echo date("Y-m-d"); ?>" disabled="disabled" class="text_purchase3"/></td>
    <td width="6%">&nbsp;</td>
    <td width="0%">&nbsp;</td>
    <td width="0%">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="16%"><input type="text" name="orderno1" id="orderno1" value="" onkeypress="keyset('orderdate',event);" class="text_purchase"/>
