...
<form name="form1" id="form1">            
  ...
  <tr>
    <td width="10%"><input type="text"  class="label_purchase" value="ARN No" disabled/></td>
    <td width="10%"><input type="text" name="invno" id="invno" value="" class="text_purchase" onkeypress="keyset('searchcust',event);"  />
  ...
  <tr>
    ...
    <td width="10%"><input type="text" name="orderno1" id="orderno1" value="" onkeypress="keyset('orderdate',event);" class="text_purchase"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input type="text" disabled="disabled" class="text_purchase" name="supplier_code" id="supplier_code"/>
