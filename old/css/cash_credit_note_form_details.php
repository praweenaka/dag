...
<form name="form1" id="form1">            
  ...
  <tr>
   ...
   <td><div id="lbllock"></div></td>
    ...
    <?php
	if ($checked=="1"){	
    	echo "<a onclick=\"NewWindow('autho.php?stname=cash_crn_form','mywin','500','300','yes','center');return false\" onfocus=\"this.blur()\">
      <input type=\"button\" name=\"searchcust6\" id=\"searchcust6\" value=\"Check\"  class=\"btn_purchase1\" />
     </a>";
	 }
	 if ($auth=="1"){ 
     	echo "<a onclick=\"NewWindow('autho.php?stname=cash_crn_form_autho','mywin','500','300','yes','center');return false\" onfocus=\"this.blur()\">
...
<fieldset>               
  ...
  <tr>
    ...
    <div class="CSSTableGenerator" id="MSFlexGrid1" > <table>
                                                        			<tr>
                                                                        ...
                                                                        <td width="10%"  background="images/headingbg.gif"><font color="#FFFFFF">Discount Val</font></td>
  ...
  <tr>
    ...
    <td><input type="text" class="text_purchase2" name="DTPicker2" onfocus="load_calader('DTPicker2')" disabled="disabled"  id="DTPicker2"/>
    </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Date" disabled="disabled"/></td>
    <td><input type="text" class="text_purchase2" name="DTPicker5" id="DTPicker5"  disabled="disabled"/>
      </td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
