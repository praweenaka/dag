	...
	///////////////////////////////////// Registration /////////////////////////////////////////////////////////////////////////
		...
		if($_GET["Command"]=="process")
		{
			...
			while ($row_rs1 = mysql_fetch_array($result_rs1)){
				...
				$result_sale =$db->RunQuery($str_sale);
				...
				$result_ret =$db->RunQuery($str_ret);
				$row_ret = mysql_fetch_array($result_ret);
