...
if ($_GET["Command"]=="search_inv"){
	...
	$ResponseXML .= "";
		...
		$ResponseXML .= "<table width=\"735\" border=\"0\" class=\"form-matrix-table\">
                            <tr>
                              <td width=\"121\"  background=\"images/headingbg.gif\" ><font color=\"#FFFFFF\">CRN No</font></td>
                              <td width=\"424\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Customer</font></td>
                             <td width=\"176\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">CRN Date</font></td>
   							</tr>";
		...
		/*	$sql="Select CAS_INV_NO_m from invpara";
			...
			$lenth=strlen($tmpinvno);
			$crn=trim("CRN/ ").substr($tmpinvno, $lenth-8);
			$_SESSION["crn"]=$crn;
...
if($_GET["Command"]=="delete_crn")
{
	...
	/*		$_SESSION["CURRENT_DOC"] = 1;      //document ID
			...
			('".$_GET["crnno"]."', '".$_GET["crndate"]."', '".$_GET["invno"]."', '".$_GET["cus_code"]."', '".$_GET["amount"]."', '".$_GET["remarks"]."', '".$_GET["salesrep"]."', '".$_GET["brand"]."', '".$_SESSION['dev']."') ";
			echo $sql;
