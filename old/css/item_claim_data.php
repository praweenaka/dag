...
if($_GET["Command"]=="new_inv")
{
  ...
  if ($_GET["Command"]=="save_inv"){
	...
	if ($row = mysql_fetch_array($result)){
		...
		$sql1="update c_clamas set entdate='".$_GET["txtentdate"]."', recieve_date='".$_GET["DTPicker_recdate"]."', cl_no='".$_GET["txtcl_no"]."', ag_code='".$_GET["txtag_code"]."', ag_name='".$_GET["txtag_name"]."', agadd='".$_GET["txtagadd"]."', cus_name='".$_GET["txtcus_name"]."', cus_add='".$_GET["txtcus_add"]."', stk_no='".$_GET["txtstk_no"]."', des='".$_GET["txtdes"]."', brand='".$_GET["txtbrand"]."', siz='".$_GET["txtsiz"]."', pr='".$_GET["txtpr"]."', patt='".$_GET["txtpatt"]."', seri_no='".$_GET["txtseri_no"]."', tc_ob='".$_GET["txttc_ob"]."', Mn_ob='".$_GET["txtmn_ob"]."', remin='".$_GET["txtremin"]."', cldate='".$_GET["txtCRE_date"]."', spec='".$_GET["txtspec"]."', remming='".$_GET["txtremming"]."', ref_per='".$_GET["txtref_per"]."', CRD_no='".$_GET["txtCRD_no"]."', CRE_date='".$_GET["txtCRE_date"]."', CRE_amount='".$_GET["txtCRE_amount"]."', origin1='".$_GET["txtorigin1"]."', origin2='".$_GET["txtorigin2"]."', origin3='".$_GET["txtorigin3"]."', origin4='".$_GET["txtorigin4"]."', origin5='".$_GET["txtorigin5"]."', remin1='".$_GET["txtremin1"]."', remin2='".$_GET["txtremin2"]."', remin3='".$_GET["txtremin3"]."', remin4='".$_GET["txtremin4"]."', remin5='".$_GET["txtremin5"]."', rem_per='".$_GET["txtrem_per"]."', Refund='".$_GET["Cmb_refund"]."', Commercialy='".$commercial."', add_ref1='".$_GET["add_ref1"]."', add_ref2='".$_GET["add_ref2"]."' where refno='".$_GET["txtrefno"]."'";
		//echo $sql1;
		...
		$sql1="insert into c_clamas  (refno, entdate, recieve_date, cl_no, ag_code, ag_name, agadd, cus_name, cus_add, stk_no, des, brand, siz, pr, patt, seri_no, tc_ob, Mn_ob, remin, cldate, spec, remming, ref_per, CRD_no, CRE_date, CRE_amount, origin1, origin2, origin3, origin4, origin5, remin1, remin2, remin3, remin4, remin5, rem_per, Refund, Commercialy, add_ref1, add_ref2) values ('".$_GET["txtrefno"]."', '".$_GET["txtentdate"]."', '".$_GET["DTPicker_recdate"]."', '".$_GET["txtcl_no"]."', '".$_GET["txtag_code"]."', '".$_GET["txtag_name"]."', '".$_GET["txtagadd"]."', '".$_GET["txtcus_name"]."', '".$_GET["txtcus_add"]."', '".$_GET["txtstk_no"]."', '".$_GET["txtdes"]."', '".$_GET["txtbrand"]."', '".$_GET["txtsiz"]."', '".$_GET["txtpr"]."', '".$_GET["txtpatt"]."', '".$_GET["txtseri_no"]."', '".$_GET["txttc_ob"]."', '".$_GET["txtmn_ob"]."', '".$_GET["txtremin"]."', '".$_GET["txtCRE_date"]."', '".$_GET["txtspec"]."', '".$_GET["txtremming"]."', '".$_GET["txtref_per"]."', '".$_GET["txtCRD_no"]."', '".$_GET["txtCRE_date"]."', '".$_GET["txtCRE_amount"]."', '".$_GET["txtorigin1"]."', '".$_GET["txtorigin2"]."', '".$_GET["txtorigin3"]."', '".$_GET["txtorigin4"]."', '".$_GET["txtorigin5"]."', '".$_GET["txtremin1"]."', '".$_GET["txtremin2"]."', '".$_GET["txtremin3"]."', '".$_GET["txtremin4"]."', '".$_GET["txtremin5"]."', '".$_GET["txtrem_per"]."', '".$_GET["Cmb_refund"]."', '".$commercial."', '".$_GET["add_ref1"]."', '".$_GET["add_ref2"]."' )";
		//echo $sql1;
		$result1 =$db->RunQuery($sql1);
	}
