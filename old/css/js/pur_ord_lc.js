...
{   
			...
			url=url+"&txt_subtot="+document.getElementById('txt_subtot').value;
			url=url+"&txt_dis="+document.getElementById('txt_dis').value;
...
function showarmyresult_addtmp()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("consumption_table");	
		document.getElementById('consumptiondetails').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("QTYINHAND");	
		document.getElementById('stock').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtunsold");	
		document.getElementById('txtunsold').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtunsold");	
		document.getElementById('txtunsold').value = XMLAddress1[0].childNodes[0].nodeValue;
