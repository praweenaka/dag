...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Stock Report As At</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_stk_as_at.php" target="_blank" method="get">
<table width="767" border="0">
  <tr>
    <td width="274" align="left">&nbsp;</td>
    <td width="120">Date</td>
    <td width="359"><input type="text" size="20" name="dte_from" id="dte_from" value="" class="text_purchase3"/>
       <script type="text/javascript">
	window.onload = function(){
		new JsDatePick({
			useMode:2,
