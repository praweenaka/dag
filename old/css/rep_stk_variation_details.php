...
<form id="form1" name="form1" action="report_stk_variation.php" target="_blank" method="get">
<table width="280" border="0">
  <tr>
    <td width="274" align="left"><table width="767" border="0">
      ...
      <tr>
        <td width="274" align="left"></td>
        <td colspan="2"><input type="submit" name="button2" id="button2" value="View" class="btn_purchase1"/></td>
      </tr>
    </table></td>
  </tr>
  <tr>
