...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Stock Consumption Report</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_consump_stock.php" target="_blank" method="get">
  ...
  <tr>
    ...
    <td width="248"><table>
      <tr>
        ...
        <td width="156"><input type="text" size="20" name="dte_from" id="dte_from" value="" class="text_purchase3"/>
           <script type="text/javascript">
	window.onload = function(){
		new JsDatePick({
			useMode:2,
