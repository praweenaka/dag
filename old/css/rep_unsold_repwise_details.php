...
<table width="767" border="0">
  <tr>
    ...
    <td width="234"><div id="over"></div></td>
  </tr>
  <tr>
    <td width="136" align="left">Department</td>
    <td width="219" align="left"><select name="department" id="department" onkeypress="keyset('brand',event);" onchange="setord();" class="text_purchase3">
      <?php
