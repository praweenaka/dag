...
if ($_GET["radio2"]=="optdate") { 
		...
		while ($row_inv = mysql_fetch_array($result_inv)){
			$sql_tmpinv="insert into tmpoutinv(REF_NO, Customer, Cus_Code, AMOUNT, paid, SDATE, sal_ex) values ('".$row_inv["REF_NO"]."', '".$row_inv["C_CODE"]."', '".$row_inv["CUS_NAME"]."', ".$row_inv["GRAND_TOT"].", 0, '".$row_inv["SDATE"]."', '".$row_inv["SAL_EX"]."')";
			$result_tmpinv =$db->RunQuery($sql_tmpinv);
	...
	if ($_GET["radio"]=="optinv"){	
		...
		if ($_GET["cmbrep"] == "All"){
		 	$sql = "SELECT * from tmpoutinv where (AMOUNT-paid)> 0"; 
		} else {
			$sql = "SELECT * from tmpoutinv where (AMOUNT-paid)> 0 and sal_ex='" . $_GET["cmbrep"] . "'"; 
		}	
            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All"){
                   if ($_GET["cmbrep"] == "All") { 
				   		...
				   		$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."') and CANCELL='0' order by SDATE";
						
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
					
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' order by SDATE";
                	}
				...
				if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by SDATE";
                   	}
				   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by SDATE";
                	}
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" .$tmpdate. "'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1' order by SDATE";
					}	
                   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep. "'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1'order by SDATE";
                	}
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."'or SDATE='".$tmpbellow."')  and CANCELL='0' order by SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep. "'and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' order by SDATE";
					}	
               }
               ...
               if ($_GET["cmbdev"] == "Computer") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover ."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by SDATE";
					}	
                   	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by SDATE";
               		}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						//echo "12";
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by SDATE";
                	}
            	}	
			}
    }    
            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpdate ."' or SDATE='".$tmpdate."') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
                   	}
					if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
                	}
               }
			   ...
			   if ($_GET["cmbdev"] == "Computer") {
                    if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
                	}
				}
                ...
                if ($_GET["cmbdev"] == "Manual") {
				   ...
				   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				   }	
                   if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
                   }
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
					}	
                }
            }
 	}
	...
	echo "<center>".$heading."</center><br>";
		...
		while($row = mysql_fetch_array($result)){
			...
			if ($row["C_CODE"]!=$ccode){
				...
				$i=1;	
				echo "<tr>
					<td colspan=9 align=left><b>".$row["C_CODE"]." ".$row["CUS_NAME"]."</b></td>
					</tr>";
			...
			<td>".$row["SAL_EX"]."</td>
			<td>".$row["SDATE"]."</td>
			<td><font color=\"#FF0000\">".$row["deli_date"]."</font></td>
			<td>".$row["REF_NO"]."</td>";
...
function currentrepcus()
{
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0'";
			}
        }
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0' and DEV='1' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' ";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0' and DEV='0' ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  ";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
        	}
		}
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "'";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT * from s_salma where Accname != 'NON STOCK' and GRAND_TOT > TOTPAY and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  and Brand='" . $_GET["cmbbrand"] . "'";
			}	
        }
	}
    	...
    	if ($_GET["chk_svat"] != "on") {
        	if ($_GET["chkcus"]=="on") {
            	if (($_GET["cmbrep"] == "All") and ($_GET["CmbBrand"] == "All") and ($_GET["radio2"]=="optdaily")) { 
					$sql = "SELECT * from fi SDATE='".$_GET["dtfrom"]."' and C_CODE='".$_GET["txt_cuscode"]."' and dev!='".$GLOBALS[$sysdiv]."'and CANCELL='0'  order by id";
				}	
