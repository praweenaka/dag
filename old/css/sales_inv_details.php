...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td width="10%"><input type="text" name="salesord1" id="salesord1" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);" onfocus="got_focus('invno');"  onblur="lost_focus('invno');"  />     </td>
  ...
  <tr>
    ...
    <td><input type="text" size="5" name="discount_org1" id="discount_org1" value="0" onkeypress="keyset('discount2',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 2" disabled="disabled"/></td>
    <td><input type="text" size="5" name="discount_org2" id="discount_org2" value="0" onkeypress="keyset('itemd_hidden',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 3" disabled="disabled"/></td>
    <td><input type="text" size="5" name="discount_org3" id="discount_org3" value="0" onkeypress="keyset('itemd_hidden',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
