...
if (($_GET["Check1"]=="true") and (trim($_GET["txt_cuscode"]) != "")) {
  if (trim($_GET["com_dep"]) == "All") {
    if (trim($_GET["Com_rep"]) == "All") {
        ...
        Else*/
           $sql = "select SDATE, REF_NO, CUS_NAME, TYPE, GRAND_TOT, TOTPAY, DEPARTMENT, SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and C_CODE='" . $_GET["txt_cuscode"] . "' and DEV='0' order by SDATE";
          $sqlstr = "select * from c_bal where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0' and CUSCODE='" . $_GET["txt_cuscode"] . "' AND trn_type<>'ARN' and trn_type<>'REC' and DEV='0' order by SDATE";
       // End if
        ...
        Else*/
        $sql = "select SDATE, REF_NO, CUS_NAME, TYPE, GRAND_TOT, TOTPAY, DEPARTMENT, SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and SAL_EX = '" . $rep . "' and C_CODE='" . $_GET["txt_cuscode"] . "' and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and SAL_EX = '" . $rep . "' and CUSCODE='" . $_GET["txt_cuscode"] . "'AND trn_type<>'ARN' and trn_type<>'REC' and DEV='0' order by SDATE";
       // End if
       ...
       Else*/
       $sql = "select SDATE, REF_NO, CUS_NAME, TYPE, GRAND_TOT, TOTPAY, DEPARTMENT, SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEPARTMENT = '" . $depart . "' and C_CODE='" . $_GET["txt_cuscode"] . "'and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and  DEP  = '" . $depart . "' and CUSCODE='" . $_GET["txt_cuscode"] . "' AND trn_type<>'ARN'and trn_type<>'REC'and DEV='0' order by  SDATE";
      // End if
       ...
       /* if rsusercon!DEV = 1 Then
        ...
        Else*/
        $sql = "select SDATE, REF_NO, CUS_NAME, TYPE, GRAND_TOT, TOTPAY, DEPARTMENT, SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEPARTMENT = '" . $depart . "'and SAL_EX = '" . $rep . "' and C_CODE='" . $_GET["txt_cuscode"] . "' and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and  DEP  = '" . $depart . "'and SAL_EX = '" . $rep . "' and CUSCODE='" . $_GET["txt_cuscode"] . "'AND trn_type<>'ARN' and trn_type<>'REC' and DEV='0' order by  SDATE";
       // End if
  ...
  if (trim($_GET["com_dep"]) == "All") {
    if (trim($_GET["Com_rep"]) == "All") {
      /* if rsusercon!DEV = 1 Then
       ...
       Else*/
        $sql = "select SDATE,REF_NO,CUS_NAME,TYPE,GRAND_TOT,TOTPAY,DEPARTMENT,SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where ( SDATE<'" . $_GET["dtto"] . "' or  SDATE='" . $_GET["dtto"] . "') and ( SDATE>'" . $_GET["dtfrom"] . "' or  SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'AND trn_type<>'ARN'and trn_type<>'REC' and DEV='0' order by  SDATE";
      // End if
        ...
        Else*/
        $sql = "select SDATE,REF_NO,CUS_NAME,TYPE,GRAND_TOT,TOTPAY,DEPARTMENT,SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and SAL_EX = '" . $rep . "' and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where ( SDATE<'" . $_GET["dtto"] . "' or  SDATE='" . $_GET["dtto"] . "') and ( SDATE>'" . $_GET["dtfrom"] . "' or  SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and SAL_EX = '" . $rep . "'AND trn_type<>'ARN'and trn_type<>'REC' and DEV='0' order by  SDATE";
       // }
       ...
       Else*/
       $sql = "select SDATE,REF_NO,CUS_NAME,TYPE,GRAND_TOT,TOTPAY,DEPARTMENT,SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEPARTMENT = '" . $depart . "' and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where ( SDATE<'" . $_GET["dtto"] . "' or  SDATE='" . $_GET["dtto"] . "') and ( SDATE>'" . $_GET["dtfrom"] . "' or  SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEP = '" . $depart . "' AND trn_type<>'ARN' and trn_type<>'REC' and DEV='0' order by  SDATE";
    ...
    Else*/
        $sql = "select SDATE,REF_NO,CUS_NAME,TYPE,GRAND_TOT,TOTPAY,DEPARTMENT,SAL_EX from s_salma where (SDATE<'" . $_GET["dtto"] . "' or SDATE='" . $_GET["dtto"] . "') and (SDATE>'" . $_GET["dtfrom"] . "' or SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and DEPARTMENT = '" . $depart . "'and SAL_EX = '" . $rep . "' and DEV='0' order by SDATE";
            $sqlstr = "select * from c_bal where ( SDATE<'" . $_GET["dtto"] . "' or  SDATE='" . $_GET["dtto"] . "') and ( SDATE>'" . $_GET["dtfrom"] . "' or  SDATE='" . $_GET["dtfrom"] . "') and CANCELL='0'and  DEP  = '" . $depart . "'and SAL_EX = '" . $rep . "'AND trn_type<>'ARN' and trn_type<>'REC' and DEV='0' order by  SDATE";
    //End if
...
while ($rssalma = mysql_fetch_array($result_sql)){
	...
	$temp="insert into tempreg(REFNO, SDATE, cus_name, AMOUNT, BALANCE, dep, SAL_EX, TRN_TYPE) values ('".$rssalma["REF_NO"]."', '".$rssalma["SDATE"]."', '".$rssalma["CUS_NAME"]."', '".$rssalma["GRAND_TOT"]."', '".$rssalma["TOTPAY"]."', '".$rssalma["DEPARTMENT"]."', '".$rssalma["SAL_EX"]."', 'INV')";
...
while ($cbal = mysql_fetch_array($result_cbal)){
	...
	if (date("Y", $cbal["SDATE"]) < 2008) {
		$BALANCE = $cbal["AMOUNT"];
	} else {
		$BALANCE = $cbal["AMOUNT"] - $cbal["BALANCE"];
	}
	
	$temp="insert into tempreg(REFNO, SDATE, cus_name, AMOUNT, BALANCE, dep, SAL_EX, TRN_TYPE) values ('".$cbal["REFNO"]."', '".$cbal["SDATE"]."', '".$rs_rst["NAME"]."', '".$cbal["AMOUNT"]."', '".$BALANCE."', '".$cbal["DEP"]."', '".$cbal["SAL_EX"]."', '".$cbal["trn_type"]."')";
	$result_temp =$db->RunQuery($temp);
}
 ...
 $ResponseXML .= "<sales_table><![CDATA[ <table><tr>
                              ...
                              <td width=\"100\"  background=\"images/headingbg.gif\"><font color=\"#FFFFFF\">Customer</font></td>
 ...
 $sql_rst= "select * from tempreg order by SDATE";
 $result_rst =$db->RunQuery($sql_rst);
 ...
 while ($rstemp = mysql_fetch_array($result_rst)){
 	...
 	if ($rstemp['TRN_TYPE']=="INV"){
 		...
 		$ResponseXML .= "<tr>                              
                             <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".$rstemp['SDATE']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".$rstemp['REFNO']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".$rstemp['cus_name']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_inv_display.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".$rstemp['SAL_EX']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_reg_amount_details.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".number_format($rstemp['AMOUNT'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_reg_paytot_details.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\"> ".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td>".$rstemp['TRN_TYPE']."</td></tr>";
		
		} else if (($rstemp['TRN_TYPE']=="CNT") or ($rstemp['TRN_TYPE']=="INC")){
		
			$ResponseXML .= "<tr>                              
                             <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SDATE']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['REFNO']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['cus_name']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('crn_display.php?crnno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SAL_EX']."</a></td>
							 <td>".number_format($rstemp['AMOUNT'], 2, ".", ",")."</td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_reg_paytot_details.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td>".$rstemp['TRN_TYPE']."</td></tr>";
			...
			$ResponseXML .= "<tr>                              
                             <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SDATE']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['REFNO']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['cus_name']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SAL_EX']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('grn_display.php?grn=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['AMOUNT'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_reg_paytot_details.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td>".$rstemp['TRN_TYPE']."</td></tr>";
			...
			$ResponseXML .= "<tr>                              
                             <td><a href=\"\" onClick=\"NewWindow('defective_item_display.php?txtrefno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SDATE']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('defective_item_display.php?txtrefno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['REFNO']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('defective_item_display.php?txtrefno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['cus_name']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('defective_item_display.php?txtrefno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".$rstemp['SAL_EX']."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('defective_item_display.php?txtrefno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['AMOUNT'], 2, ".", ",")."</a></td>
							 <td><a href=\"\" onClick=\"NewWindow('sales_reg_paytot_details.php?refno=".$rstemp['REFNO']."&trn_type=".$rstemp['TRN_TYPE']."','mywin','900','700','yes','center');return false\" onFocus=\"this.blur()\">".number_format($rstemp['BALANCE'], 2, ".", ",")."</a></td>
							 <td>".$rstemp['TRN_TYPE']."</td></tr>";					 
