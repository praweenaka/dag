...
<tr>
					<?php 
	  				$stname = $_GET["stname"];
					?>
                             <td width="122"  background="images/headingbg.gif" ><input type="text" size="20" name="cusno" id="cusno" value="" class="txtbox" onkeyup="<?php	echo "update_cust_list('$stname')"; ?>"/></td>
      <td width="603"  background="images/headingbg.gif" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
                ...
                <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                            <tr>
                              ...
                              <td width="424"  background="images/headingbg.gif"><font color="#FFFFFF">Customer Name</font></td>
							...
							$sql="select REFNO , SDATE, BALANCE, SAL_EX  from c_bal where Cancell='0' and BALANCE>0 and CUSCODE = '".$_SESSION['uti_cus_code']."' and trn_type!='ARN' ORDER BY SDATE desc limit 50";
