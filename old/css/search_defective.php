...
<tr>					
      ...
      <td width="603"  background="images/headingbg.gif" ><input type="text" size="50" name="invdate" id="invdate" value="" class="txtbox"/></td>
                ...
                <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							$sql="select REFNO, BAT_NO, CLAM_NO, SDATE  from s_deftrn where  CANCELL='0' ORDER BY SDATE desc limit 50";
							...
							echo "<tr>               
                              ...
                              <td onclick=\"defect('".$row['REFNO']."');\">".$row['BAT_NO']."</a></td>
                              <td onclick=\"defect('".$row['REFNO']."');\">".$row['CLAM_NO']."</a></td>
							  <td onclick=\"defect('".$row['REFNO']."');\">".$row['SDATE']."</a></td>
                            </tr>";
							}
							  ?>
                    </table>
