...
<tr>
					<?php 
	  				$stname = $_GET["stname"];
					?>
                             <td width="122"  background="images/headingbg.gif" ><input type="text" size="20" name="repno" id="repno" value="" class="txtbox" onkeyup="<?php	echo "update_rep_list('$stname')"; ?>"/></td>
      <td width="603"  background="images/headingbg.gif" ><input type="text" size="70" name="repname" id="repname" value="" class="txtbox" onkeyup="<?php echo "update_rep_list('$stname')"; ?>"/></td>
      </table>    
              <div class="CSSTableGenerator" > 
                <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							$stname = $_GET["stname"];
							$sql="SELECT REPCODE, Name from s_salrep";
