   ...
   <div class="CSSTableGenerator" > 
                <div id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
						...
						if ($_SESSION["MonthView1"]!=""){	
								...
								$sql="select REF_NO , SDATE, GRAND_TOT  from s_salma where Accname != 'NON STOCK' and CANCELL='0' and C_CODE='" . $_SESSION["suppno"] . "' and year(SDATE)='".$year."' and month(SDATE)='".$month."' ORDER BY SDATE desc limit 50";
								//echo $sql;
