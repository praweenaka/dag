...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td colspan="2">
      <input type="text" size="20" name="dtdate" id="dtdate" value="<?php echo date("Y-m-d"); ?>"  class="text_purchase3"/>
    </td>
    <td> </td>
  </tr>
  <tr>
...
<input type="checkbox" name="chkinv" id="chkinv" onclick="settle_inv();" />Settle Invoice   
  ...
  <tr>
    ...
    <td colspan="3"><input type="hidden" name="mcount" id="mcount" />
      <input type="hidden" name="mcount_chq" id="mcount_chq" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><a href="serach_customer.php?stname=ret_chq_settle" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()"></a></td>
    <td>&nbsp;</td>
  </tr>
  </table>
...
<table width="799" border="0">
  <tr>
    <td width="144"><input type="text"  class="label_purchase" value="Cash" disabled="disabled"/></td>
    <td width="127"><input type="text" size="20" name="txtcash" id="txtcash" value=""  class="text_purchase3"/></td>
...
<fieldset>               
  ...
  <table width="84%" border="0">
      ...
      <tr>
        ...
        <td><input type="text" size="20" name="txtchno" id="txtchno" value="" class="text_purchase3"/></td>
        <td>&nbsp;</td>
        <td><input type="text"  class="label_purchase" value="Cheque Date" disabled="disabled"/></td>
        <td><input type="text"  class="text_purchase3" size="10" id="DTPicker1" name="DTPicker1" onfocus="load_calader('DTPicker1')" />
        
      </td>
    </tr>
      <tr>
        <td><input type="text"  class="label_purchase" value="Bank" disabled="disabled"/></td>
        <td><input type="text" size="20" name="txtchbank" id="txtchbank" value="" class="text_purchase3"/></td>
        <td>&nbsp;</td>
        <td><input type="text"  class="label_purchase" value="Amount" disabled="disabled"/></td>
        <td><input type="text" size="20" name="txtamount" id="txtamount" value="" class="text_purchase3"/></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
