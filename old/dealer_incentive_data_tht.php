...
if ($_POST["Command"] == "print_advance") {
    ...
    while ($mRow < $_POST["mcount"]) {
        ...
        $cell_name_16 = "TypeGrid_" . $mRow . "_16";
        ...
        if ($_POST[$cell_name_03] != "") {
            $amount = ($val_col_03 / (1 + ($_POST[$cell_name_16] / 100)));
        }
        if ($_POST[$cell_name_05] != "") {
            $brand = $_POST[$cell_name_05];
        }
        if ($_POST[$cell_name_08] != "") {
            $paid = ($val_col_08 / (1 + ($_POST[$cell_name_16] / 100)));
        }
        ...
        if (($val_col_08 != "") and ( $val_col_08 != "0")) {
            $per = ($val_col_13 / ($val_col_08 / (1 + ($_POST[$cell_name_16] / 100)))) * 100;
        }
...
if (isset($_POST["Command"])) {
    ...
    if ($_POST["Command"] == "calculate_ins") {
        ...
        // getting commition % for sale
        if (trim($_POST["cmbtype"]) == "Tyre") {
            $sql_rsper = "Select * from intper where incen_year = 2014 and traget < '" . (($txttot1_w - $txt_grn_w)) . "' order by traget desc ";
            $sql_rsper = "Select * from intper where sdate <= '" . $_POST["DTPicker1"] . "' and traget  <= '" . (($txttot1_w - $txt_grn_w)) . "'  and class='" . $_POST['cmbtype'] . "' order by sdate desc,traget desc ";
        }

        if (trim($_POST["cmbtype"]) == "Battery") {
            $sql_rsper = "Select * from intper where incen_year = 20111 and traget < '" . (($txttot1_w - $txt_grn_w)) . "' order by traget desc ";
        }

        if (trim($_POST["cmbtype"]) == "Atlas") {
            $sql_rsper = "Select * from intper where incen_year = 2015 and traget < '" . (($txttot1_w - $txt_grn_w)) . "' order by traget desc ";
        }
            ...
            if (trim($_POST["cmbtype"]) == "Tyre") {
                ...
                while ($ii < $TypeGrid1_count) {
                    ...
                    if ($_POST[$TypeGrid14] == "INV") {
                        ...
                        if ($m75 > 0) {
                            ...
                            if (($_POST[$TypeGrid09] <= 50) and ( $_POST[$TypeGrid15] != "UT")) {
                                $TypeGrid[$ii][13] = (str_replace(",", "", $_POST[$TypeGrid08]) / 100 * ($row_rsper['per'] + $row_rsper['add'])) / ($_POST[$TypeGrid16] + 100) * 100;
                            } else {
                                if ($_POST[$TypeGrid09] <= $_POST[$TypeGrid10]) {
                                    $TypeGrid[$ii][13] = (str_replace(",", "", $_POST[$TypeGrid08]) / 100 * $row_rsper['per']) / ($_POST[$TypeGrid16] + 100) * 100;
                                } else {
                                    $TypeGrid[$ii][13] = 0;
                                }
                            }
                        ...
                        if ($m75 > 0) {
                            $TypeGrid[$ii][13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * $row_rsper['per']) / ($_POST[$TypeGrid16] + 100) * 100;
                        } else {
                            $TypeGrid[$ii][13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * ($row_rsper['per'] + $row_rsper['add'])) / ($_POST[$TypeGrid16] + 100) * 100;
                        }
                    }
                    $ii = $ii + 1;
                }
                ...
                while ($ii < $TypeGrid1_count) {
                    ...
                    if ($_POST[$TypeGrid14] == "INV") {
                        if ($m75 > 0) {
                            if ($_POST[$TypeGrid09] <= $_POST[$TypeGrid10]) {
                                $TypeGrid[$ii][13] = (str_replace(",", "", $_POST[$TypeGrid08]) / 100 * $txt_percentage) / ($_POST[$TypeGrid16] + 100) * 100;
                            } else {
                                $TypeGrid[$ii][13] = 0;
                            }
                        } else {
                        ...
                        if ($m75 > 0) {
                            $TypeGrid[$ii][13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * $txt_percentage) / ($_POST[$TypeGrid16] + 100) * 100;
                        } else {
                            $TypeGrid[$ii][13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * ($txt_percentage)) / ($_POST[$TypeGrid16] + 100) * 100;
                        }
                    }
        ...
        while ($ii < $TypeGrid1_count) {
            ...
            if ($_POST[$TypeGrid14] == "INV") {
                if ($_POST[$TypeGrid09] <= $_POST[$TypeGrid10]) {
                    $txttot1 = $txttot1 + str_replace(",", "", $_POST[$TypeGrid08]);
                    $txttot1_w = $txttot1_w + ($val_TypeGrid08 / (1 + $_POST[$TypeGrid16] / 100));
                    //echo ($val_TypeGrid08/(1+$_POST[$TypeGrid16]/100));
                }
            } else {
                $txt_grn_w = $txt_grn_w + ($val_TypeGrid03 / (1 + $_POST[$TypeGrid16] / 100));
            }
    ...
    if ($_POST["Command"] == "save_advance") {
        ...
        // $mrefno = date("m/Y", strtotime($_POST["DTPicker1"])) . "-" . $_POST["cmbrep"] . "-" . $_POST["cmbdev"];
        //Call Auto_cal--------------------------------------------------------
        ...
        if ($row_rsper = mysqli_fetch_array($result_rsper)) {
            ...
            $ii = 1;
            $ddate = "2011-07-31";
            $diff = abs(strtotime($ddate) - strtotime($_POST["DTPicker1"]));
            $days = floor($diff / (60 * 60 * 24));
                    ...
                    if ($_POST[$TypeGrid14] == "INV") {
                        if ($m75 > 0) {
                            if (($_POST[$TypeGrid09] <= 50) and ( $_POST[$TypeGrid15] == "CHK")) {
                                $_POST[$TypeGrid13] = (str_replace(",", "", $_POST[$TypeGrid08]) / 100 * ($txt_percentage + 1)) / ($txt_vat + 100) * 100;
                            } else {
                                if ($_POST[$TypeGrid09] <= $_POST[$TypeGrid10]) {
                                    $_POST[$TypeGrid13] = (str_replace(",", "", $_POST[$TypeGrid08]) / 100 * $txt_percentage) / ($txt_vat + 100) * 100;
                                } else {
                                    $_POST[$TypeGrid13] = 0;
                                }
                            }
                        ...
                        if ($m75 > 0) {
                            $_POST[$TypeGrid13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * $txt_percentage) / ($txt_vat + 100) * 100;
                        } else {
                            $_POST[$TypeGrid13] = -1 * (str_replace(",", "", $_POST[$TypeGrid03]) / 100 * ($txt_percentage + 1)) / ($txt_vat + 100) * 100;
                        }
                    }
                    $ii = $ii + 1;
                }
        ...
        while ($ii < $TypeGrid1_count) {
            ...
            if ($_POST[$TypeGrid13] != "") {
                $tinc = ($tinc + str_replace(",", "", $_POST[$TypeGrid13]) );
            }
            $ii = $ii + 1;
        }
...
if ($_GET["Command"] == "proces") {
    ...
    $sql_rssslma = "select * from view_s_salma_brand_mas_incentive where  month(sdate1)='" . date("m", strtotime($_GET["DTPicker1"])) . "' and  year(sdate1)='" . date("Y", strtotime($_GET["DTPicker1"])) . "' and c_CODE = '" . $_GET["txt_cuscode"] . "' and sfrom <='" . $dtfrom . "' and sto >='" . $dtfrom . "' and inc_type='" . $_GET['cmbtype'] . "' and cancell='0' and totpay1 = '1'";
    ...
    while ($row_rssslma = mysqli_fetch_array($result_rssslma)) {
        ...
        if ((!is_null($row_rssslma['deli_date'])) and $row_rssslma['deli_date'] != "0000-00-00") {
        ...
        while ($row_rssttr = mysqli_fetch_array($result_rssttr)) {
         ...
         if ($row_rssttr["deliin_amo"] > 0) {
            if (is_null($row_rssttr["deliin_days"]) == false) {
        ...
        $TypeGrid1[$ii][16] = $row_rssslma["GST"];
...
$sql_rsIncen = "select * from ins_payment where  I_month ='" . intval(date("m", strtotime($_GET["DTPicker1"]))) . "'  and I_year='" . date("Y", strtotime($_GET["DTPicker1"])) . "' and cusCode = '" . trim($_GET["txt_cuscode"]) . "' and Type = '" . $_GET["cmbtype"] . "'  order by id";
//echo $sql_rsIncen;
...
$sql_RScbal = "select * from view_cbal_brand_incentive where month(sdate1)='" . date("m", strtotime($_GET["DTPicker1"])) . "' and  year(sdate1)='" . date("Y", strtotime($_GET["DTPicker1"])) . "' and CANCELL='0'and CUSCODE='" . trim($_GET["txt_cuscode"]) . "' AND trn_type != 'ARN' and trn_type != 'REC' and trn_type != 'DGRN' and flag1 != '1'  and sfrom <='" . $dtfrom . "' and sto >='" . $dtfrom . "' and inc_type='" . $_GET['cmbtype'] . "' order by sdate1";
...
while ($row_RScbal = mysqli_fetch_array($result_RScbal)) {
    ...
    if ($x == 0) {
        ...
        $TypeGrid1[$ii][12] = -($TypeGrid1[$ii][3] / 100 * $_GET["txt_percentage"]) / ($row_RScbal["vatrate"] + 100) * 100;
        $TypeGrid1[$ii][13] = -($TypeGrid1[$ii][3] / 100 * $_GET["txt_percentage"]) / ($row_RScbal["vatrate"] + 100) * 100;
        ...
        $TypeGrid1[$ii][16] = $row_RScbal["vatrate"];
        $ii = $ii + 1;
    }
}
...
while ($i < $TypeGrid1_count) {
    ...
    if ($TypeGrid1[$i][14] == "INV") {
        if ($TypeGrid1[$i][9] <= $TypeGrid1[$i][10]) {
            $txttot1 = $txttot1 + str_replace(",", "", $TypeGrid1[$i][8]);
        } else {
            $txttot1 = $txttot1;
        }
    }
...
if (trim($_GET["cmbtype"]) == "Tyre") {
    ...
    $sql_rsper = "Select * from intper where sdate <= '" . $_GET["DTPicker1"] . "' and traget  <= '" . (($txttot1 - $txt_grn) / ($txt_vat + 100) * 100) . "'  and class='" . $_GET['cmbtype'] . "' order by sdate desc,traget desc ";
}
    ...
    if (trim($_GET["cmbtype"]) == "Tyre") {
            ...
            if ($TypeGrid1[$ii][14] == "INV") {
                if ($m75 > 0) {
                    if (($TypeGrid1[$ii][9] <= 50) and ( $TypeGrid1[$ii][15] == "CHK")) {
                        $TypeGrid1[$ii][13] = (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * ($row_rsper['per'] + $row_rsper['add'])) / ($txt_vat + 100) * 100;
                    } else {
                        if ($TypeGrid1[$ii][9] <= $TypeGrid1[$ii][10]) {
                            $TypeGrid1[$ii][13] = (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * $row_rsper['per']) / ($txt_vat + 100) * 100;
                        } else {
                            $TypeGrid1[$ii][13] = 0;
                        }
                    }
                ...
                if ($m75 > 0) {
                    $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][3]) / 100 * $row_rsper['per']) / ($txt_vat + 100) * 100;
                } else {
                    $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][3]) / 100 * ($row_rsper['per'] + $row_rsper['add'])) / ($txt_vat + 100) * 100;
                }
            }
            $ii = $ii + 1;
        }
        ...
        while ($ii < $TypeGrid1_count) {
            if ($TypeGrid1[$ii][14] == "INV") {
                ...
                $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * $row_rsper['per']) / ($txt_vat + 100) * 100;
            }
            $ii = $ii + 1;
        }
    }
...
while ($ii < $TypeGrid1_count) {
    ...
    if ($TypeGrid1[$ii][13] != "") {
        $tinc = ($tinc + str_replace(",", "", $TypeGrid1[$i][13]));
    }
    $ii = $ii + 1;
}
...
while ($i < $TypeGrid1_count) {
    ...
    <td width=\"60\"  ><div id=\"" . $grid15 . "\">" . $TypeGrid1[$i][15] . "</td>
    <td width=\"60\"  ><div id=\"" . $grid16 . "\">" . $TypeGrid1[$i][16] . "</td></tr>";
        ...
        if (trim($_GET["cmbtype"]) == "Tyre") {
            while ($ii < $TypeGrid1_count) {
                if ($TypeGrid1[$ii][14] == "INV") {
                    if ($m75 > 0) {
                        if (($TypeGrid1[$ii][9] <= 50) and ( $TypeGrid1[$ii][15] == "CHK")) {
                            $TypeGrid1[$ii][13] = (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * ($txt_percentage + 1)) / ($txt_vat + 100) * 100;
                        } else {
                            if ($TypeGrid1[$ii][9] <= $TypeGrid1[$ii][10]) {
                                $TypeGrid1[$ii][13] = (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * $txt_percentage) / ($txt_vat + 100) * 100;
                            } else {
                                $TypeGrid1[$ii][13] = 0;
                            }
                        }
                    ...
                    if ($m75 > 0) {
                        $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][3]) / 100 * $txt_percentage) / ($txt_vat + 100) * 100;
                    } else {
                        $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][3]) / 100 * ($txt_percentage + 1)) / ($txt_vat + 100) * 100;
                    }
                }
                $ii = $ii + 1;
            }
            ...
            while ($ii < $TypeGrid1_count) {
                if ($TypeGrid1[$ii][14] == "INV") {
                    ...
                    $TypeGrid1[$ii][13] = -1 * (str_replace(",", "", $TypeGrid1[$i][8]) / 100 * $txt_percentage) / ($txt_vat + 100) * 100;
                }
                $ii = $ii + 1;
            }
        }
