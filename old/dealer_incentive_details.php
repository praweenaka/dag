...
<script type="text/javascript" src="js/dealer_incentive_tht.js"></script>
...
<form name="form1" id="form1">  
 <table border="0"><tr><td width="1301">         
  ...
  <tr>
    ...
    <option value='Tyre' selected="selected">Tyre</option>
...
<fieldset>
<input  style="font-size:20px;color:red;" type="text" size="20" name="txt_out" id="txt_out" value=""/>
