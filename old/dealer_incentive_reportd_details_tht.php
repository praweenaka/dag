...
<form name="form1" id="form1">  
 <table border="0"><tr><td width="1301">         
  ...
  <tr>
    ...
    <td width="13%" colspan="2"><div class="style1" id="wait_res"></div></td>
    <td width="12%" colspan="2"><input type="text"  class="label_purchase" value="Brand" disabled="disabled"/></td>
    <td width="12%"><select name="cmbbrand" id="cmbbrand" class="text_purchase3">
