...
<fieldset>
  ...
  <tr>
    ...
    <?php 
		if ($_SESSION['company']=="BEN"){
    		echo "<input type=\"text\"  class=\"label_purchase\" value=\"BDRN No\" disabled=\"disabled\"/>";
		} else if ($_SESSION['company']=="THT"){
			echo "<input type=\"text\"  class=\"label_purchase\" value=\"DGRN No\" disabled=\"disabled\"/>";
		}	
   ?>
   </td>
  ...
  <tr>
    ...
    <td width="10%" colspan="2"><textarea name="txtremark" id="txtremark" cols="45" rows="5"></textarea></td>
    <td><input type="text" name="cl_no1" id="cl_no1" disabled="disabled" /><input type="text" name="def_no" id="def_no" disabled="disabled" /></td>
    <td bgcolor="#00CCCC"><label>
      <input type="radio" name="vatgroup" value="vat" id="vatgroup_0"   />
    ...
    <td bgcolor="#00CCCC"><label>
      <input type="radio" name="vatgroup" value="evat" id="vatgroup_3"  />
  ...
  <tr>
    ...
    <td width="10%"><input type="text"  class="label_purchase" value="Claim No" disabled="disabled"/></td>
    <td colspan="2"><input type="text" size="5" name="txtcl_no" id="txtcl_no" value="" onblur="keyset('discount2',event);" class="text_purchase"/></td>
...
<input type="hidden" id="c_subcode" name="c_subcode" value="">
...
<fieldset>               
  ...
  <tr>
    ...
    <td><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" size="40" id="item_name" name="item_name" disabled="disabled" onkeypress="keyset('rate',event);" />
    </font></td>
    <td><font color="#FFFFFF">
      <input type="text" size="15" name="partno" id="partno" value="" disabled="disabled" class="text_purchase3" onkeypress="keyset('qty',event);"/>
    </font></td>
    <td><font color="#FFFFFF">
      <input type="text" size="15" name="rate" id="rate" value="" onblur="settotal();" class="text_purchase3" onkeypress="keyset('additem_tmp',event);"/>
    </font></td>
    <td><font color="#FFFFFF">
    ...
    <td><font color="#FFFFFF">
      <input type="text" size="15" name="refund" id="refund" value="" class="text_purchase3" onblur="settotal();"/>
    </font></td>
    <td><font color="#FFFFFF">
      <input type="text" size="15" name="total" id="total" value="" class="text_purchase3" onkeypress="keyset('additem_tmp',event);" onblur="set_tot();"/>
    </font></td>
    </tr>
  <tr>
	<td colspan="6">
  ...
  <tr>
    ...
    <td><input type="text" size="15" name="txt_net" id="txt_net" value="0" class="text_purchase3" disabled="disabled"/></td>
    <td>&nbsp;</td>
  </tr>
