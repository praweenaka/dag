...
{   
			...
			if (xmlHttp==null)
			{
				...
				var url="search_ledger_data_acc.php";			
				url=url+"?Command="+"pass_unknown";
				url=url+"&l_refno="+l_refno;
							
				//alert(url);
			xmlHttp.onreadystatechange=passcusresult_unknown;
			xmlHttp.open("GET",url,true);
			xmlHttp.send(null);
}

function passcusresult_unknown()
{
	var XMLAddress1;
	...
	{
		//alert(xmlHttp.responseText);
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("l_amount");	
		...
		opener.document.form1.ledg_ref_no.value=XMLAddress1[0].childNodes[0].nodeValue;
