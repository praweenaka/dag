...
{ 
  var ctn1 = 'ctn1' + count;
  var ctn = 'ctn' + count;
  var ctnqty1 = 'ctnqty1' + count;
  var ctnqty = 'ctnqty' + count;
  var qty = 'qty' + count; 
  var cost = 'cost' + count;
  ...
  if (document.getElementById(ctn1).value == "") {
    ctn_val1 = 0;
    } else {
        // if((document.getElementById(ctn1).value) > (document.getElementById(ctn).value)){
        //     alert('Ctn is Grater Than...');
        //     return;
        //     ctn_val1 = 0;
        // }else{
            ctn_val1 = parseFloat(document.getElementById(ctn1).value);
        // }

    }

    if (document.getElementById(ctnqty1).value == "") {
        ctnqty_val1 = 0;
    } else {
        // if((document.getElementById(ctnqty1).value) > (document.getElementById(ctnqty).value)){
        //     alert('Ctn Qty is Grater Than...');
        //     return;
        //     ctnqty_val1 = 0;
        // }else{
            ctnqty_val1 = parseFloat(document.getElementById(ctnqty1).value);
        // }

    }

    document.getElementById(qty).value = ctnqty_val1 * ctn_val1;
    ...
    // document.getElementById(totqty).value = qty_val;
    ...
    while (i < totcount) {
        ...
        if (document.getElementById(qty).value != '') { 
            totqty = parseFloat(totqty) + parseFloat(document.getElementById(qty).value);
        }
        i = i + 1;
    }
    ...
    document.getElementById("total_qty").value = totqty;
...
function save_inv(inv_status)
{
    ...
    if (document.getElementById('invno').value != "") {
        if (document.getElementById('total_value').value != "0") {
        ...
        params = params + "&lc_no=" + document.getElementById('lc_no').value;
        params = params + "&pi_no=" + document.getElementById('pi_no').value;
        params = params + "&brand=" + document.getElementById('brand').value;
        params = params + "&department=" + document.getElementById('department').value;
        params = params + "&dte_dor=" + document.getElementById('invdate').value;
        params = params + "&supplier_code=" + document.getElementById('supplier_code').value;
        params = params + "&supplier_name=" + document.getElementById('supplier_name').value;
        params = params + "&textarea=" + document.getElementById('textarea').value;
        ...
        params = params + "&purtype=" + document.getElementById('purtype').value;
        params = params + "&count=" + document.getElementById('count').value;
        params = params + "&contsize=" + document.getElementById('contsize').value;
        params = params + "&arpend=" + document.getElementById('arpend').value;
        ...
        while (i < document.getElementById('count').value) {
            ...
            //  params = params + "&" + ctn + "=" + document.getElementById(ctn).value;
            //  params = params + "&" + ctnqty + "=" + document.getElementById(ctnqty).value;
            // params = params + "&" + ctn1 + "=" + document.getElementById(ctn1).value;
            //  params = params + "&" +ctnqty1 + "=" + document.getElementById(ctnqty1).value;
            i = i + 1;
        }
...
function update_arstat()
{
    ...
    var url = "arn_data.php";
    url = url + "?Command=" + "update_arstat";
    url = url + "&refno=" + document.form1.invno.value;
    url = url + "&arpend=" + document.form1.arpend.value;
    //alert(url);

    xmlHttp.onreadystatechange = result_pass_update_arstat;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function result_pass_update_arstat()
{
    var XMLAddress1;
...
function result_pass_arnno()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("arpend");
        opener.document.form1.arpend.value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("contsize");
        opener.document.form1.contsize.value = XMLAddress1[0].childNodes[0].nodeValue;
...
function new_inv()
{
    ...
    var objpurtype = document.getElementById("purtype");
    objpurtype.options[0].selected = true;

    document.getElementById('country').value = "";
    document.getElementById('textarea').value = "";

    var objcostcenter = document.getElementById("costcenter");
    objcostcenter.options[0].selected = true;
...
function update_list(stname)
{
    ...
    if (document.getElementById('invno').value != "") {
        ...
        url = url + "&mstatus=lcno";
    }

    url = url + "&invno=" + document.getElementById('invno').value;
    url = url + "&customername=" + document.getElementById('customername').value;
    url = url + "&lcno=" + document.getElementById('invdate').value;
