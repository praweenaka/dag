...
{   
		...
		//alert(inv_status);
			...
			url=url+"&dte_dor="+document.getElementById('invdate').value;
			...
			url=url+"&textarea="+document.getElementById('textarea').value;
			...
			url=url+"&purtype="+document.getElementById('purtype').value;
			...
			while (i<document.getElementById('count').value){
				...
				url=url+"&"+ord_qty+"="+document.getElementById(ord_qty).value;
				url=url+"&"+fob+"="+document.getElementById(fob).value;
				url=url+"&"+qty+"="+document.getElementById(qty).value;
				url=url+"&"+acc_cost+"="+document.getElementById(acc_cost).value;
				url=url+"&"+selling+"="+document.getElementById(selling).value;
				url=url+"&"+margin+"="+document.getElementById(margin).value;
				url=url+"&"+subtotal+"="+document.getElementById(subtotal).value;
				url=url+"&"+cost+"="+document.getElementById(cost).value;
				
				url=url+"&"+qtyinhand+"="+document.getElementById(qtyinhand).value;
				i=i+1;
			}
...
function cal_sub(i, mcou)
{
	...
	while (mcou>j){
		...
		cost="cost"+j;
		qty="qty"+j;
		document.getElementById(subtotal).value=parseFloat(document.getElementById(cost).value)*parseFloat(document.getElementById(qty).value)
		mtot=mtot+parseFloat(document.getElementById(subtotal).value);
		j=j+1;
	}
	
	document.getElementById('total_value').value=mtot;
}
...
{   
			...
			} else if (document.getElementById('lcno').value!=""){
			...
			url=url+"&invno="+document.getElementById('invno').value;
			url=url+"&lcno="+document.getElementById('lcno').value;
