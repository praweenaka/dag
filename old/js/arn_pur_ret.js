...
function cal_subtot(count, totcount)
{
	...
	if (document.getElementById('checkbox').checked == false) {
		...
		while (i<totcount){
    		...
    		if (parseFloat(document.getElementById(retqty).value) > 0) {
        		//document.getElementById(value).value = parseFloat(document.getElementById(retqty).value) * parseFloat(document.getElementById(price).value) * (100 - parseFloat(document.getElementById(preretqty).value)) / 100;
				document.getElementById(value).value = parseFloat(document.getElementById(retqty).value) * parseFloat(document.getElementById(price).value) ;
        		dTotal = dTotal + parseFloat(document.getElementById(value).value);
				//alert(parseFloat(document.getElementById(value).value));
			}
			i=i+1;
		}
	}
...
{   
		...
		if (document.getElementById('pur_ret_no').value==""){
			...
			url=url+"&cus_code="+document.getElementById('firstname_hidden').value;
			url=url+"&cus_name="+document.getElementById('firstname').value;		
...
{   
		    ...
		    var objpurtype = document.getElementById("department");
...
function print_inv()
{
 ...
 /*	var url="inv_data.php";			
	...
	var url="rep_pur_ret.php";			
			url=url+"?invno="+document.getElementById('pur_ret_no').value;
			window.open(url);
