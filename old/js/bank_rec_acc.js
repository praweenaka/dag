...
function lastmonthcal()
{
	...
	var url="bank_recon_data.php";	
	
	url=url+"?Command="+"lastmonthcal";
	url=url+"&txtBankCode="+document.getElementById('Com_CAS').value;
	url=url+"&dtpDate="+document.getElementById('dtpDate').value;
	
	//alert(url);
	
	xmlHttp.onreadystatechange=lastmonthcal_results;
	xmlHttp.open("GET",url,true);
	xmlHttp.send(null);	
}

function lastmonthcal_results()
{
	var XMLAddress1;
//	alert(xmlHttp.responseText);
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
		{ 	
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txt_bankbal");	
			document.getElementById('txt_bankbal').value = XMLAddress1[0].childNodes[0].nodeValue;			
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("dtfrom");	
			document.getElementById('dtfrom').value = XMLAddress1[0].childNodes[0].nodeValue;			
...
function display()
{
	...
	url=url+"?Command="+"display";
	url=url+"&txtBankCode="+document.getElementById('Com_CAS').value;
	url=url+"&dtpDate="+document.getElementById('dtpDate').value;
	url=url+"&txt_bankbal="+document.getElementById('txt_bankbal').value;
	
	//alert(url);
	
	xmlHttp.onreadystatechange=display_results;
	xmlHttp.open("GET",url,true);
	xmlHttp.send(null);	
}
...
function display_results()
{
	...
	alert(xmlHttp.responseText);
		...
		{ 	
			...
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("debtable");	
			//alert(XMLAddress1[0].childNodes[0].nodeValue);
			document.getElementById('flexDeb').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;			
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cretable");	
			document.getElementById('flexCre').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;		
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtbankpay");	
			document.getElementById('txtbankpay').value = XMLAddress1[0].childNodes[0].nodeValue;		
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtbankdepo");	
			document.getElementById('txtbankdepo').value = XMLAddress1[0].childNodes[0].nodeValue;		
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtFinalBal");	
			document.getElementById('txtFinalBal').value = XMLAddress1[0].childNodes[0].nodeValue;		
			
			
			
			XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtclosebal");	
			document.getElementById('txtclosebal').value = XMLAddress1[0].childNodes[0].nodeValue;	
...
function checkdb(refno, id, type)
{
	xmlHttp=GetXmlHttpObject();
	if (xmlHttp==null)
	{
	...
	url=url+"?Command="+"checkdb";
	url=url+"&refno="+refno;
	url=url+"&id="+id;
	url=url+"&type="+type;
	url=url+"&chk="+document.getElementById(refno).checked;
	...
	xmlHttp.onreadystatechange=checkdb_results;
	xmlHttp.open("GET",url,true);
	xmlHttp.send(null);	
}


function checkdb_results()
{
	var XMLAddress1;
	alert(xmlHttp.responseText);
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
...
function print_recon()
{
			...
			var url="rep_bank_recon.php";			
			url=url+"?txtBankCode="+document.getElementById('Com_CAS').value;
			url=url+"&dtpDate="+document.getElementById('dtpDate').value;
			url=url+"&txtBankClosBal="+document.getElementById('txtBankClosBal').value;
			url=url+"&txtbankpay="+document.getElementById('txtbankpay').value;
			url=url+"&txtbankdepo="+document.getElementById('txtbankdepo').value;
			url=url+"&txtclosebal="+document.getElementById('txtclosebal').value;
			url=url+"&txt_bankbal="+document.getElementById('txt_bankbal').value;
...
function passcusresult_ledger()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		//alert(xmlHttp.responseText);
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("c_code");	
		opener.document.form1.txtLinkNo.value=XMLAddress1[0].childNodes[0].nodeValue;
