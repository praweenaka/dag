...
function view_his() {
	...
	var url = "batt_inv_data.php";
	url = url + "?Command=" + "view_his";

	url = url + "&c_code=" + document.getElementById('cuscode').value;
...
function salescancelresult() {
	...
	if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
		...
		document.getElementById('itemdetails1').innerHTML = xmlHttp.responseText;
	}
}
...
function save_me() {
	...
	url = url + "&txtqty=" + document.getElementById('txtqty').value;
	url = url + "&c_code=" + document.getElementById('cuscode').value;
	url = url + "&rep=" + document.getElementById('cmbrep').value;
        
	url = url + "&stk_no=" + document.getElementById('txtstk_no').value;
	url = url + "&sdate=" + document.getElementById('invdate').value;
