...
{   
		...
		/*	document.getElementById('debit_acc').value="";
			...
			var objsalesrep = document.getElementById("CMBPAYTYPE");
			objsalesrep.options[0].selected=true;
			
			var objdepartment = document.getElementById("com_costcent");
			...
			document.getElementById('txt_accode').value="";
			document.getElementById('txt_accname').value="";
			document.getElementById('txt_accode1').value="";
			document.getElementById('txt_accname1').value="";
		
			document.getElementById('chq_table').innerHTML="";
			
			document.getElementById('Txtchtot').value="";
...
function assign_invno(){
	...
	document.getElementById('Txtrecno').value= XMLAddress1[0].childNodes[0].nodeValue;
...
function cal_tot()
{
	...
	if (document.getElementById('txtcash').value!=""){
		txtcash=parseFloat(document.getElementById('txtcash').value);
	}
	
	if (document.getElementById('Txtchtot').value!=""){
		Txtchtot=parseFloat(document.getElementById('Txtchtot').value);
	}
	
	document.getElementById('txtpaytot').value=txtcash+Txtchtot;
}
...
function addchq_cash_rec()
{
			...
			url=url+"&invno="+document.getElementById('Txtrecno').value;
...
function addchq_cash_rec_result()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("chqtot");	
		document.getElementById('Txtchtot').value= XMLAddress1[0].childNodes[0].nodeValue;
		
		if (document.getElementById('txtcash').value!=""){
			txtcash	=document.getElementById('txtcash').value;
		} else {
			txtcash=0;	
		}
		
		if (document.getElementById('Txtchtot').value!=""){
			Txtchtot	=document.getElementById('Txtchtot').value;
		} else {
			Txtchtot=0;	
		}
		
		document.getElementById('txtpaytot').value=parseFloat(Txtchtot)+parseFloat(txtcash);
...
function save_crec()
{
	xmlHttp=GetXmlHttpObject();
			...
			url=url+"&Txtrecno="+document.getElementById("Txtrecno").value;
			url=url+"&txtDATE="+document.getElementById("txtDATE").value;
			url=url+"&txt_accode="+document.getElementById("txt_accode").value;
			url=url+"&txt_accname="+document.getElementById("txt_accname").value;
			url=url+"&txt_accode1="+document.getElementById("txt_accode1").value;
			url=url+"&txt_accname1="+document.getElementById("txt_accname1").value;
			url=url+"&CMBPAYTYPE="+document.getElementById("CMBPAYTYPE").value;
			url=url+"&TXTAC_REF="+document.getElementById("TXTAC_REF").value;
			...
			url=url+"&Txtchtot="+document.getElementById('Txtchtot').value;
