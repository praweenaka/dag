...
function new_crn()
{
    ...
    document.getElementById('remarkk').value = "";
    ...
    document.getElementById("remk").style.visibility = "hidden";
...
function p_remk() {
    ...
    var url = "crn_data.php";
    url = url + "?Command=" + "p_remk";


    url = url + "&refno=" + document.getElementById('crnno').value;
    url = url + "&remk=" + document.getElementById('remarkk').value;


    xmlHttp.onreadystatechange = show_p_rmres;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
...
function result_pass_crnno()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lock");
        if (XMLAddress1[0].childNodes[0].nodeValue == "2") {
            window.opener.document.getElementById('lock').innerHTML = "<div style='color:#FF0000'><font size='+3'>Locked</font></div>";
            window.opener.document.getElementById("auth").style.visibility = "visible";

            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("tb");
            window.opener.document.getElementById("tb").innerHTML = XMLAddress1[0].childNodes[0].nodeValue;



            window.opener.document.getElementById("remk").style.visibility = "visible";

        }


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("p_remk");
        if (XMLAddress1[0].childNodes[0].nodeValue != "") {

            opener.document.form1.remarkk.value = XMLAddress1[0].childNodes[0].nodeValue;
        }
