...
{   
			...
			if (document.getElementById('discount_org1').value == '0.00'){ document.getElementById('discount_org1').value=''; }
			if (document.getElementById('discount_org2').value == '0.00'){ document.getElementById('discount_org2').value=''; }
			if (document.getElementById('discount_org3').value == '0.00'){ document.getElementById('discount_org3').value=''; }
...
function cancel_inv()
{
	...
	if (msg==true){
		xmlHttp=GetXmlHttpObject();
			...
			url=url+"&salesord1="+document.getElementById('txt_invno').value;
...
{   
			...
			document.getElementById('discount_org1').disabled=true;
		//	document.getElementById('discount_org2').disabled=true;
		//	document.getElementById('discount_org3').disabled=true;
			
			var url="cus_ord_data.php";			
			url=url+"?Command="+"add_tmp";
			url=url+"&invno="+document.getElementById('txt_invno').value;
...
{   
		...
		//} else {
			...
			url=url+"&txt_invno="+document.getElementById('txt_invno').value;
			//url=url+"&salesord2="+document.getElementById('salesord2').value;
			//url=url+"&invno="+document.getElementById('invno').value;
			url=url+"&dtdate="+document.getElementById('dtdate').value;
			url=url+"&DTdateto="+document.getElementById('DTdateto').value;
			...
			url=url+"&department="+document.getElementById('department').value;
			url=url+"&brand="+document.getElementById('brand').value;
			url=url+"&txt_chetot="+document.getElementById('txt_chetot').value;
			...
			url=url+"&vatmethod="+vatmethod;
			url=url+"&discount1="+document.getElementById('discount_org1').value;
			url=url+"&discount2="+document.getElementById('discount_org2').value;
			url=url+"&discount3="+document.getElementById('discount_org3').value;
			...
			url=url+"&txt_chetot="+document.getElementById('txt_chetot').value;
			url=url+"&txt_cash="+document.getElementById('txt_cash').value;
			url=url+"&txt_ordno="+document.getElementById('txt_ordno').value;
			url=url+"&DTREQ_DATE="+document.getElementById('DTREQ_DATE').value;
...
/*	xmlHttp=GetXmlHttpObject();
	...
	url=url+"?Command="+"achivement";
			...
			//alert(url);
			window.open(url);
		//	xmlHttp.onreadystatechange=achivementresult;
		//	xmlHttp.open("GET",url,true);
			//xmlHttp.send(null);
...
{   
			...
			var d = new Date();
			document.getElementById('dtdate').value=d.yyyymmdd();
			
			var today = new Date();
			var tomorrow = new Date();
			tomorrow.setDate(today.getDate()+7);
			document.getElementById('DTdateto').value=tomorrow.yyyymmdd();
			...
			document.getElementById('txt_invno').value="";
			...
			document.getElementById('discount_org1').value="40";
...
function assign_invno(){
	//alert(xmlHttp.responseText);
	document.getElementById('txt_invno').value=xmlHttp.responseText;	
...
{   
			...
			if (xmlHttp==null)
			{
				...
				var url="search_ord_data.php";			
				url=url+"?Command="+"pass_invno_cus_ord";
				url=url+"&invno="+invno;
				url=url+"&stname="+stname;
...
function passinvresult()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.txt_invno.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DTappdate");
		opener.document.form1.dtdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("dtdate");
		opener.document.form1.dtdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DTdateto");
		opener.document.form1.DTdateto.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblvatno");
		opener.document.form1.vat1.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txt_cusadd");
		opener.document.form1.cus_address.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Op_credit");
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DIS_per");
		opener.document.form1.discount_org1.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txt_subtot");
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DTREQ_DATE");
		opener.document.form1.DTREQ_DATE.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("DTappdate");
		opener.document.form1.DTappdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("com_dep");
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cmbbrand");
		opener.document.form1.brand.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Op_nonvat");
		if (XMLAddress1[0].childNodes[0].nodeValue=="true"){
...
function custno1(custno, stname)
{   
			//alert(stname);
...
{   
			...
			url=url+"&discount1="+opener.document.form1.discount_org1.value;
			url=url+"&discount2="+opener.document.form1.discount_org2.value;
			url=url+"&discount3="+opener.document.form1.discount_org3.value;
