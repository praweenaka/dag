...
function calc1()
{
    ...
    if (document.getElementById('discount1').value == '0.00') {
        document.getElementById('discount1').value = '';
    }
    if (document.getElementById('discount2').value == '0.00') {
        document.getElementById('discount2').value = '';
    }
    if (document.getElementById('discount3').value == '0.00') {
...
function pass_defect_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.form1.def_no.value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cl_no");
        opener.document.form1.cl_no1.value = XMLAddress1[0].childNodes[0].nodeValue;

        //opener.document.form1.total.value.focus();
...
function defect_d(refno)
{
    ...
    var url = "defective_data.php";
    url = url + "?Command=" + "pass_defectno1";
    url = url + "&txtrefno=" + refno;
...
function pass_defect_result_d()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cl_refno");
        opener.document.form1.def_no.value = XMLAddress1[0].childNodes[0].nodeValue;
...
function cancel_inv()
{
    ...
    if (msg == true) {
        ...
        url = url + "&cl_no1=" + document.getElementById('cl_no1').value;
        url = url + "&def_no=" + document.getElementById('def_no').value;
...
function set_tot()
{
    document.getElementById('txt_net').value = document.getElementById('total').value;
}
...
function new_inv()
{
    ...
    document.getElementById('c_subcode').value = "";
...
function update_list_d(stname)
{
    ...
    xmlHttp.onreadystatechange = showinvresult_search;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);

}

function showinvresult_search()
{
    var XMLAddress1;
...
function print_inv()
{
    ...
    myString = document.getElementById('txt_cusname').value;
...
function approve(refno)
{
    ...
    var url = "defective_data.php";
    url = url + "?Command=" + "approve1";
    url = url + "&txtrefno=" + refno;


    //alert(url);
    xmlHttp.onreadystatechange = approve_list;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}
...
function reject(refno, clno, def, net, ccode, rep)
{
...
function update_list_approve(stname)
{
    ...
    var url = "defective_data.php";
    url = url + "?Command=" + "SetListNameapprove";
...
function denie(refno)
{
    var msg = confirm("Are you sure to Denie ! ");
    if (msg == true) {
        xmlHttp = GetXmlHttpObject();
        if (xmlHttp == null)
        {
        ...
        var url = "defective_data.php";
        url = url + "?Command=" + "denie";
        url = url + "&txtrefno=" + refno;

        xmlHttp.onreadystatechange = showarmyresultdenie_inv;
        xmlHttp.open("GET", url, true);
        xmlHttp.send(null);
    }
}

function showarmyresultdenie_inv()
{
    var XMLAddress1;
...
function hide()
{
    var msg = confirm("Are you sure to Hide ! ");
    if (msg == true) {
        ...
        var url = "defective_data.php";
        url = url + "?Command=" + "hide";

        url = url + "&invno=" + document.getElementById('txtrefno').value;

        xmlHttp.onreadystatechange = result_hide;
        xmlHttp.open("GET", url, true);
        xmlHttp.send(null);
