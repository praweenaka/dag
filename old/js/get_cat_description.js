...
function page_load()
{
	get_cat_description(document.getElementById('category').value);
	get_center_unit(document.getElementById('center').value);
}



function get_cat_description(cat_val)
{
	...
	var url="get_cat_descript.php";			
	url=url+"?Command="+"get_cat_descript";		
