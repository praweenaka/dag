...
function calc_tot()
{
   // var subtot = (parseFloat(document.getElementById("rate").value) * parseFloat(document.getElementById("qty").value));
    // var disc = subtot * (parseFloat(document.getElementById("discount").value) / 100);

    // document.getElementById("discount_amt").value = disc;
    // document.getElementById("subtot_new").value = subtot - disc;
    // ========
    var subtot=(parseFloat(document.getElementById("rate").value)*parseFloat(document.getElementById("qty").value));
	var disc=subtot*(parseFloat(document.getElementById("discount").value)/100);
	var subtot=subtot-disc; 
...
//alert('asdas');
        ...
        if (valqty >= totret) {
            ...
            if (document.getElementById('vatgroup_1').checked == false) {
                ...
                if (document.getElementById('gst').value != "") {
                    document.getElementById('tax').value = (parseFloat(before_vat) * (parseFloat(document.getElementById('gst').value))) / 100;  //vatrate		
                } else {
                    document.getElementById('tax').value = (parseFloat(before_vat) * 8) / 100;  //vatrate		
                }
    ...
    if (chkinvno == "2") {
        ...
        if (document.getElementById('vatgroup_1').checked == false) {
//alert('asdsa');
            document.getElementById('tax').value = (before_vat * 8) / 100;	 //vatrate
...
function calc_inv_tot()
{
    ...
    if (document.getElementById('vatgroup_1').checked == false) {
        document.getElementById('tax').value = (before_vat * 8) / 100;
        //alert(before_vat);
...
function add_tmp()
{
    ...
    if (document.getElementById('vatgroup_1').value == true) {
        vatgrp = "vat";
    } else {
...
function save_inv(inv_status)
{
    ...
    if (document.getElementById('grnno').value != "") {
        if (document.getElementById('txtstoRef').value != "") {
            ...
            url = url + "&txtstoRef=" + document.getElementById('txtstoRef').value;
...
function assign_invno() {
    ...
    if (xmlHttp.responseText == "no") {
        ...
        document.getElementById('gst').value = XMLAddress1[0].childNodes[0].nodeValue;
