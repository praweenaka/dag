...
function salessaveresult()
{
	...
	if (xmlHttp.responseText=="no"){
	  ...
	  if (xmlHttp.responseText=="Invoice Facilitey Stoped for This Customer,Please Invoice For Approved Sales Order"){
		alert(xmlHttp.responseText);	  
...
function print_inv_ben_non()
{
	
	if (document.getElementById('cmd_print').value==1){	
			var url="rep_inv_ben_non.php";			
			url=url+"?invno="+document.getElementById('invno').value;
