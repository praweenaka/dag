...
function setbrand(stname)
{
	...
	xmlHttp.onreadystatechange=setitem_setbrand;
	xmlHttp.open("GET",url,true);
	xmlHttp.send(null);	
}

function setitem_setbrand()
{
	var XMLAddress1;
...
{   
			...
			url=url+"?Command="+"search_item_cliaim";
