...
function clear_item()
{
    ...
    //alert("ok");
    document.getElementById('txtdelivered').value = "";
    // document.getElementById('disitem').value = "";
...
function lock_itm()
{
    ...
    url = url + "?Command=" + "item_stop";
    url = url + "&txt_cuscode=" + document.getElementById('txtSTK_NO').value;
    url = url + "&chkstop=" + document.getElementById('check1').checked;
    url = url + "&chkstop1=" + document.getElementById('check2').checked;
...
function stopinvcing_result()
{
    ...
    {
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("mloc");
        if (XMLAddress1[0].childNodes[0].nodeValue == "1") {
            document.getElementById('check1').checked = true;
        } else {
            document.getElementById('check1').checked = false;
        }
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("mloc1");
        if (XMLAddress1[0].childNodes[0].nodeValue == "1") {
