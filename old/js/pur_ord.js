...
{   
			...
			url=url+"&ctn="+document.getElementById('ctn').value;
			url=url+"&ctnqty="+document.getElementById('ctnqty').value;
...
{   
			...
			document.getElementById('edit_log').innerHTML="";
...
function passpurordresult_ind()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
	  ...
	  if (str.length>575){
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("log");
		document.getElementById('edit_log').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
...
function passpurordresult()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("log");
		window.opener.document.getElementById('edit_log').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
...
function calq() {
    ...
    document.getElementById('qty').value = XMLAddress1[0].childNodes[0].nodeValue;
