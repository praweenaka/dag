...
function view_inv()
{
    ...
    var url = "qty_credit_note_auto_data.php";
    url = url + "?Command=" + "view_inv";
    url = url + "&combo1=" + document.getElementById('combo1').value;
    url = url + "&dte_dor=" + document.getElementById('dte_dor').value;
    ...
    xmlHttp.onreadystatechange = view_inv_result;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function view_inv_result()
{
    var XMLAddress1;
...
function save_inv()
{
    ...
    var ans = confirm("Not Retunabale, Do you Want To Save the Entry ? ");
    ...
    if (ans == true) {
        ...
        alert(url);
        xmlHttp.onreadystatechange = save_inv_result;
        xmlHttp.open("GET", url, true);
        xmlHttp.send(null);
    }
}
...
function changechk(inc, code)
{
    ...
    xmlHttp.onreadystatechange = changechk_result;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function changechk_result()
{
    var XMLAddress1;
