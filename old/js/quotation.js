...
function setwar() {
   ...
   document.getElementById('Combo1').value =   document.getElementById('Combo11').value;
...
function cancel_inv()
{
    ...
    var msg = confirm("Do you want to CANCEL this Quotation ! ");
    if (msg == true) {
        xmlHttp = GetXmlHttpObject();
        if (xmlHttp == null)
        {
...
function save_inv(inv_status)
{
    ...
    url=url+"&txt_milage="+document.getElementById('txt_milage').value;
...
function print_inv()
{
    ...
    var url = "rep_quotation.php";
//	url=url+"?Command="+"check_print";
    url = url + "?invno=" + document.getElementById('invno').value;
    url = url + "&Op_vat=" + document.getElementById('vatgroup_1').checked;
    url = url + "&TXTREMARK=" + document.getElementById('TXTREMARK').value;
    url = url + "&COM_GROUPS=" + document.getElementById('COM_GROUPS').value;
    url = url + "&cus_address=" + document.getElementById('cus_address').value;
