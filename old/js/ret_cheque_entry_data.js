    ...
    if (document.getElementById('lblReciptNo').value == "") {
        ...
        if (document.getElementById('txtChequeNo').value == "") {
            ...
            if (document.getElementById('accno').value != "") {
                ...
                url = url + "&txtretcount=" + document.getElementById('txtretcount').value;
                url = url + "&txtoriginal=" + document.getElementById('txtoriginal').value;
                ...
                while (mcount > i) {
                    REF_NO = "REF_NO_" + i;
                    SDATE = "SDATE_" + i;
                    GRAND_TOT = "GRAND_TOT_" + i;
                    st_amou = "st_amou_" + i;

                    url = url + "&" + REF_NO + "=" + document.getElementById(REF_NO).innerHTML;
                    url = url + "&" + SDATE + "=" + document.getElementById(SDATE).innerHTML;
                    url = url + "&" + GRAND_TOT + "=" + document.getElementById(GRAND_TOT).innerHTML;
                    url = url + "&" + st_amou + "=" + document.getElementById(st_amou).innerHTML;
...
function clear()
{
    ...
    document.getElementById('txtretcount').value = "";
}
...
function print_inv()
{
    var url = "report_cheque_history.php";
    url = url + "?txtChequeNo=" + document.getElementById('txtChequeNo').value;
    url = url + "&che_date=" + document.getElementById('DTPicker2').value;
    window.open(url);
...
{
    if ((document.getElementById('lblReciptNo').value != "")) {
        var msg = confirm("Do you want to Update  this Reason ! ");
        if (msg == true) {
            xmlHttp = GetXmlHttpObject();
            if (xmlHttp == null)
            {
            ...
            var url = "ret_cheque_entry_data.php";
            url = url + "?Command=" + "up_remark";

            url = url + "&lblReciptNo=" + document.getElementById('lblReciptNo').value;
            url = url + "&reason=" + document.getElementById('reason').value;

            xmlHttp.onreadystatechange = result_remark;
            xmlHttp.open("GET", url, true);
            xmlHttp.send(null);
        }
    } else {
        alert("Entry No is Empty...! ");
    }
}
function result_remark()
{
    var XMLAddress1;
