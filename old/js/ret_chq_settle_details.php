...
<fieldset>               
  ...
  <table width="84%" border="0">
	...
	window.onload = function(){
        ...
        <td width="17%"><input type="button" name="additem_tmp" id="additem_tmp" value="Add" onClick="addchq_cash_rec();" class="btn_purchase1" /></td>
      </tr>
      <tr>
        <td colspan="4"><div class="CSSTableGenerator" id="chq_table" >
          <table width="71%">
              <tr>
