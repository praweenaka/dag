...
function save_advance() {
    ...
    url = url + "&Critaria_gridA11=" + document.getElementById('Critaria_gridA11').value;
    url = url + "&Critaria_gridA12=" + document.getElementById('Critaria_gridA12').value;
    url = url + "&Critaria_gridA21=" + document.getElementById('Critaria_gridA21').value;
    url = url + "&Critaria_gridA22=" + document.getElementById('Critaria_gridA22').value;
    url = url + "&Critaria_gridA31=" + document.getElementById('Critaria_gridA31').value;
    url = url + "&Critaria_gridA32=" + document.getElementById('Critaria_gridA32').value;

    url = url + "&Critaria_gridB11=" + document.getElementById('Critaria_gridB11').value;
    url = url + "&Critaria_gridB12=" + document.getElementById('Critaria_gridB12').value;
    url = url + "&Critaria_gridB21=" + document.getElementById('Critaria_gridB21').value;
    url = url + "&Critaria_gridB22=" + document.getElementById('Critaria_gridB22').value;
    url = url + "&Critaria_gridB31=" + document.getElementById('Critaria_gridB31').value;
    url = url + "&Critaria_gridB32=" + document.getElementById('Critaria_gridB32').value;
