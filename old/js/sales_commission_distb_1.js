...
function grnhistory() {
	...
	var url = "sales_commission_distb_data_1.php";
...
function proces() {
	...
	url = url + "&Deduction_grid12=" + document.getElementById('Deduction_grid12').value;
...
function assign_proces() {
	...
	if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Sales_gridB52");
		document.getElementById('Sales_gridB52').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Sales_gridA52");
		document.getElementById('Sales_gridA52').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Sales_gridB51");
		document.getElementById('Sales_gridB51').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Sales_gridA51");
		document.getElementById('Sales_gridA51').value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid31");
		document.getElementById('Deduction_grid31').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid32");
		document.getElementById('Deduction_grid32').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid41");
		document.getElementById('Deduction_grid41').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid42");
		document.getElementById('Deduction_grid42').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid51");
		document.getElementById('Deduction_grid52').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid61");
		document.getElementById('Deduction_grid61').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid62");
		document.getElementById('Deduction_grid62').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid71");
		document.getElementById('Deduction_grid71').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid72");
		document.getElementById('Deduction_grid72').value = XMLAddress1[0].childNodes[0].nodeValue;

		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("Deduction_grid81");
		document.getElementById('Deduction_grid81').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function calculation() {
	...
	url = url + "&Sales_gridA23=" + document.getElementById('Sales_gridA23').value;
	url = url + "&Sales_gridA33=" + document.getElementById('Sales_gridA33').value;
	url = url + "&Sales_gridA43=" + document.getElementById('Sales_gridA43').value;

	url = url + "&Sales_gridB23=" + document.getElementById('Sales_gridB23').value;
	url = url + "&Sales_gridB33=" + document.getElementById('Sales_gridB33').value;
	url = url + "&Sales_gridB43=" + document.getElementById('Sales_gridB43').value;

	url = url + "&Deduction_grid11=" + document.getElementById('Deduction_grid11').value;
	url = url + "&Deduction_grid12=" + document.getElementById('Deduction_grid12').value;
	url = url + "&Deduction_grid13=" + document.getElementById('Deduction_grid13').value;
	url = url + "&Deduction_grid21=" + document.getElementById('Deduction_grid21').value;
	url = url + "&Deduction_grid22=" + document.getElementById('Deduction_grid22').value;
	url = url + "&Deduction_grid31=" + document.getElementById('Deduction_grid31').value;
	url = url + "&Deduction_grid32=" + document.getElementById('Deduction_grid32').value;
...
function save_advance() {
	...
	url = url + "&grn=" + document.getElementById('totsal_grid21').value;
	url = url + "&advance=" + document.getElementById('txt_cadv').value; 
	
	
	url = url + "&over60out=" + document.getElementById('totsal_grid31').value;  
	url = url + "&over60ratio=" + document.getElementById('totsal_grid41').value;
	 
	url = url + "&sale_tyre=" + document.getElementById('Sales_gridB11').value;
	url = url + "&GRN_a=" + document.getElementById('Sales_gridB21').value;
	url = url + "&sale_Battery=" + document.getElementById('Sales_gridA11').value;
	url = url + "&GRN_b=" + document.getElementById('Sales_gridA21').value;
	
	url = url + "&sale_Aw=" + document.getElementById('Sales_gridA51').value;
	url = url + "&Sale_tube=" + document.getElementById('Sales_gridB51').value; 

	url = url + "&tar_salA=" + document.getElementById('Sales_gridA22').value; 
	url = url + "&tar_salb=" + document.getElementById('Sales_gridA32').value; 
	url = url + "&tar_salc=" + document.getElementById('Sales_gridA42').value; 

	url = url + "&Com_tyre=" + document.getElementById('Sales_gridA23').value; 			
	url = url + "&Com_battery=" + document.getElementById('Sales_gridA33').value; 			
	url = url + "&Com_Aw=" + document.getElementById('Sales_gridA43').value;
	url = url + "&txt_rded=" + document.getElementById('txt_rded').value;
	
	 			
	url = url + "&crn_a=" + document.getElementById('Sales_gridB22').value; 			
	url = url + "&crn_b=" + document.getElementById('Sales_gridB32').value; 			
	url = url + "&crn_c=" + document.getElementById('Sales_gridB42').value; 		
		
	url = url + "&Crn_d=" + document.getElementById('Sales_gridB23').value; 			
	url = url + "&CRN=" + document.getElementById('Sales_gridB33').value; 			
	url = url + "&Com_tube=" + document.getElementById('Sales_gridB43').value; 			
...
function print_advance() {
	...
	url = url + "&Sales_gridA22=" + document.getElementById('Sales_gridA22').value;
	url = url + "&Sales_gridA23=" + document.getElementById('Sales_gridA23').value;

	url = url + "&Sales_gridA42=" + document.getElementById('Sales_gridA42').value;
	url = url + "&Sales_gridA43=" + document.getElementById('Sales_gridA43').value;

	url = url + "&Sales_gridB22=" + document.getElementById('Sales_gridB22').value;
	url = url + "&Sales_gridB23=" + document.getElementById('Sales_gridB23').value;

	url = url + "&Sales_gridB42=" + document.getElementById('Sales_gridB42').value;
	url = url + "&Sales_gridB43=" + document.getElementById('Sales_gridB43').value;

	url = url + "&totsal_grid41=" + document.getElementById('totsal_grid41').value;
...
function print_rep()
{
		...
		//if (xmlHttp.responseText==1){
			var url="rep_commission_rep.php";			
		/*	url=url+"?invno="+document.getElementById('invno').value;
			url=url+"&paytype="+document.getElementById('paytype').value;
