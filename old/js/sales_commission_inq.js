...
function getdATA()
{
	...
	var url="sales_commission_inq_data.php";			
	url=url+"?Command="+"getdATA";
	url=url+"&dtMonth="+document.getElementById('dtMonth').value;
	url=url+"&cmbrep="+document.getElementById('cmbrep').value;
	url=url+"&optApp="+document.getElementById('optApp').checked;
	url=url+"&optAll="+document.getElementById('optAll').checked;
	alert(url);
...
function setcell(count, dayno, dayno2)
{
	...
	//if (parseFloat(document.getElementById(days).value)<dayno2){
		document.getElementById(pay).innerHTML="Yes";
	//} else {
	//	document.getElementById(pay).innerHTML="No";	
	//}
}
...
function update()
{
	...
	while (mcount>i){
		...
		url=url+"&"+ap_rem_name+"="+document.getElementById(ap_rem_name).innerHTML;
