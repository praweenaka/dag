...
function getdATA() {
    ...
    alert(url);
    xmlHttp.onreadystatechange = assign_getdATA;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function assign_getdATA() {

    var XMLAddress1;

    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        alert(xmlHttp.responseText);
        document.getElementById('gridinv').innerHTML = xmlHttp.responseText;
        upremark();
        //XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtt1");
        //document.getElementById('gridinv').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
    }
}
...
function calcc() {
    ...
    var url = "sales_commission_inq_data_tht.php";
    url = url + "?Command=" + "calcc";
    url = url + "&dtMonth=" + document.getElementById('dtMonth').value;
    url = url + "&cmbrep=" + document.getElementById('cmbrep').value;
    url = url + "&radio=" + document.getElementById('radio').value;
    xmlHttp.onreadystatechange = assign_getdATA1;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function assign_getdATA1() {

    var XMLAddress1;

    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("TOTSALEALL");
        document.getElementById('txtnetsale').value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("TOTRETS");
        document.getElementById('txtret').value = XMLAddress1[0].childNodes[0].nodeValue;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("TOTNSALEALL");
        document.getElementById('txtnet').value = XMLAddress1[0].childNodes[0].nodeValue;


        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("out");
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("totnocom");
...
function getsett(invno, brand) {
    ...
    xmlHttp.onreadystatechange = assign_getsett;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function assign_getsett() {

    var XMLAddress1;

    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        alert(xmlHttp.responseText);
        //document.getElementById('TypeGrid1').innerHTML = xmlHttp.responseText;

        //alert(xmlHttp.responseText);
        //document.getElementById('MSHFlexGrid1').innerHTML = xmlHttp.responseText;

        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("TypeGrid1");
        document.getElementById('TypeGrid1').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
...
function setcell(count, dayno, dayno2) {
    alert(dayno + "-" + dayno2);
    var days = "days_" + count;
    var pay = "pay_" + count;


    document.getElementById(pay).innerHTML = "Yes";
...
function update() {
    ...
    while (mcount > i) {
        ...
        url = url + "&" + id_name + "=" + document.getElementById(id_name).innerHTML;
        url = url + "&" + paid_name + "=" + document.getElementById(paid_name).innerHTML;
        url = url + "&" + day_name + "=" + document.getElementById(day_name).value;
        url = url + "&" + pay_name + "=" + document.getElementById(pay_name).innerHTML;
        url = url + "&" + ap_rem_name + "=" + document.getElementById(ap_rem_name).value;

        i = i + 1;
    }

    alert(url);
    xmlHttp.onreadystatechange = passcusresult_update;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}

function passcusresult_update() {
