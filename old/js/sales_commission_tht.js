...
function print1()
{
    ...
    var url = "sales_commission_data_sp_tht.php";
    url = url + "?Command=" + "print1";
    ...
    xmlHttp.onreadystatechange = assign_print1;
...
function print_view1()
{
    var url = "report_commission_balane.php";
    ...
    url = url + "&txtComSale=" + document.getElementById('txtComSale').value;
...
function savegrn() {
    ...
    while (i < document.getElementById('grngrid').value) {
        ...
        params = params + "&" + gtype + "=" + document.getElementById(gtype).innerHTML;
        params = params + "&" + grnno + "=" + document.getElementById(grnno).innerHTML;
        params = params + "&" + Commi + "=" + document.getElementById(Commi).innerHTML;
        params = params + "&" + commman + "=" + document.getElementById(commman).value;

        i = i + 1;
    }
    params = params + "&grngrid=" + document.getElementById('grngrid').value;
...
function assign_view_report() {
    ...
    {
        alert(xmlHttp.responseText);
        var msg = confirm("Do You Wish to save Commission ?");
        if (msg == true) {
            print_rep();
        }
    }
...
function display_comm()
{
    ...
    var url = "search_commission_data.php";
    url = url + "?Command=" + "display_comm";
    url = url + "&Com_rep=" + document.getElementById('Com_rep').value;
    //alert(url);

    xmlHttp.onreadystatechange = assign_display_comm;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);
}


function assign_display_comm() {
...
function view_com(refno) {
    var url = "report_commission_balane1.php";
    url = url + "?refno=" + refno;
    url = url + "&salrep=" + document.getElementById('Com_rep').value;
...
function view_summery()
{
    ...
    alert("Wait untill display result");

    document.getElementById('wait_message').innerHTML = "Wait untill display result";
//alert(url);
...
function passcusresult_view_summery() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("out_tot");
        document.getElementById('txtout_tot').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtdedamt2");
        document.getElementById('txtdedamt2').value = XMLAddress1[0].childNodes[0].nodeValue;
...
function eff_sale()
{
    ...
    var url = "sales_commission_data_sp_tht.php";
    url = url + "?Command=" + "eff_sale";
    url = url + "&txtTOTNocom=" + document.getElementById('txtTOTNocom').value;
    url = url + "&txtRetChkAmou_D1=" + document.getElementById('txtRetChkAmou_D1').value;
    url = url + "&txtRetChkAmou_Do=" + document.getElementById('txtRetChkAmou_Do').value;
    url = url + "&txtTotnet=" + document.getElementById('txtTotnet').value;
    url = url + "&cmbdev=" + document.getElementById('cmbdev').value;
    url = url + "&txtnet=" + document.getElementById('txtnet').value;
    url = url + "&txtTotnet=" + document.getElementById('txtTotnet').value;
    url = url + "&txtNocomm=" + document.getElementById('txtNocomm').value;

    alert(url);
    xmlHttp.onreadystatechange = passcusresult_eff_sale;
    xmlHttp.open("GET", url, true);
    xmlHttp.send(null);

}

function passcusresult_eff_sale() {
...
function save_advance() {
    ...
    var url = "sales_commission_data_sp_tht.php";
    var params = "Command=" + "save_advance";
    params = params + "&dtMonth=" + document.getElementById('dtMonth').value;
    params = params + "&msgridcount=" + document.getElementById('msgridcount').value;
    params = params + "&txtper=" + document.getElementById('txtper').value;
    params = params + "&txtded=" + document.getElementById('txtded').value;
    params = params + "&txtdedremark=" + document.getElementById('txtdedremark').value;
    ...
    while (mgridcount > i) {
        ...
        params = params + "&" + msgrid1 + "=" + document.getElementById(msgrid1).innerHTML;
        params = params + "&" + msgrid2 + "=" + document.getElementById(msgrid2).innerHTML;
        params = params + "&" + msgrid3 + "=" + document.getElementById(msgrid3).innerHTML;
        params = params + "&" + msgrid4 + "=" + document.getElementById(msgrid4).innerHTML;
        params = params + "&" + msgrid5 + "=" + document.getElementById(msgrid5).innerHTML;
        params = params + "&" + msgrid6 + "=" + document.getElementById(msgrid6).innerHTML;


        i = i + 1;
    }

    params = params + "&txtretcheq=" + document.getElementById('txtretcheq').value;
    params = params + "&txtadvance=" + document.getElementById('txtadvance').value;
    params = params + "&Txtadva=" + document.getElementById('Txtadva').value;

    params = params + "&txtad=" + document.getElementById('txtad').value;
    params = params + "&cmbrep=" + document.getElementById('cmbrep').value;
    params = params + "&TXTADJ=" + document.getElementById('TXTADJ').value;
    params = params + "&txtded1=" + document.getElementById('txtded1').value;
    params = params + "&txtded2=" + document.getElementById('txtded2').value;
    params = params + "&txtded3=" + document.getElementById('txtded3').value;
    params = params + "&txtded4=" + document.getElementById('txtded4').value;
    params = params + "&txtded5=" + document.getElementById('txtded5').value;
    params = params + "&txtded6=" + document.getElementById('txtded6').value;
    params = params + "&txtded7=" + document.getElementById('txtded7').value;
    params = params + "&txtded8=" + document.getElementById('txtded8').value;
    params = params + "&txtdedamou1=" + document.getElementById('txtdedamou1').value;
    params = params + "&txtdedamou2=" + document.getElementById('txtdedamou2').value;
    params = params + "&txtdedamou3=" + document.getElementById('txtdedamou3').value;
    params = params + "&txtdedamou4=" + document.getElementById('txtdedamou4').value;
    params = params + "&txtdedamou5=" + document.getElementById('txtdedamou5').value;
    params = params + "&txtdedamou6=" + document.getElementById('txtdedamou6').value;
    params = params + "&txtdedamou7=" + document.getElementById('txtdedamou7').value;
    params = params + "&txtdedamou8=" + document.getElementById('txtdedamou8').value;
    params = params + "&txtover60=" + document.getElementById('txtover60').value;
    params = params + "&TXTRATO=" + document.getElementById('TXTRATO').value;
    params = params + "&txtretioded=" + document.getElementById('txtretioded').value;
    params = params + "&cmbdev=" + document.getElementById('cmbdev').value;
    params = params + "&mgridcount=" + document.getElementById('mgridcount').value;
...
//    }
//
//    var url = "sales_commission_inq_data_tht.php";
//    url = url + "?Command=" + "setremark";
//    url = url + "&dtMonth=" + document.getElementById('dtMonth').value;
//    url = url + "&cmbrep=" + document.getElementById('cmbrep').value;
//
//    xmlHttp.onreadystatechange = assign_upremark;
//    xmlHttp.open("GET", url, true);
//    xmlHttp.send(null);
//}
//
//function assign_upremark() {
//
//    var XMLAddress1;
//
//    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
//
//        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("mcount1");
//        document.getElementById('TXTREMARK').value = XMLAddress1[0].childNodes[0].nodeValue;
//    }
//}