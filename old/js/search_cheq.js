...
function ret_chq(cheque_no, che_date, che_amount, stname)
{   
			...
			if (stname=="ret_cheque_entry"){
				var url="search_chq_data.php";			
				url=url+"?Command="+"pass_arr";
				url=url+"&txtChequeNo="+cheque_no;
				url=url+"&che_date="+che_date;
				url=url+"&che_amount="+che_amount;
				url=url+"&stname="+stname;
...
function chq_extn(cheque_no, che_date, che_amount, stname, cusno,bank)
{   
			...
			if (xmlHttp==null)
			{
				...
				url=url+"&cusno="+cusno;
				url=url+"&bank="+bank;
				url=url+"&txtchexdate="+opener.document.form1.txtchexdate.value;
				
				xmlHttp.onreadystatechange=passinvresult_chq_extn;
				xmlHttp.open("GET",url,true);
				xmlHttp.send(null);
...
function passinvresult_chq_extn()
{
	var XMLAddress1;
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("refno");
		opener.document.form1.typeref.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("recdate");
		opener.document.form1.recdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtch_no");
		opener.document.form1.txtch_no.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtsal_ex");
		opener.document.form1.txtsal_ex.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtch_amount");
		opener.document.form1.txtch_amount.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtch_date");
		opener.document.form1.txtch_date.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("sales_table");
		window.opener.document.getElementById('itemdetails').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("ex_date1");
		opener.document.form1.txtfirstdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("ex_date2");
		opener.document.form1.txtseconddate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblmodi");
		window.opener.document.getElementById('lblmodi').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
...
function chq_mod(cheque_no, che_date, che_amount, stname, cusno,bank)
{   
			...
			if (xmlHttp==null)
			{
				...
				var url="search_chq_data.php";			
				url=url+"?Command="+"modify";
				url=url+"&txtChequeNo="+cheque_no;
				url=url+"&stname="+stname;
				url=url+"&cusno="+cusno;
				url=url+"&bank="+bank;
				
				xmlHttp.onreadystatechange=passinvresult_chq_mod;
				xmlHttp.open("GET",url,true);
				xmlHttp.send(null);
...
function passinvresult_chq_mod()
{
	var XMLAddress1;
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("recdate");
		opener.document.form1.txtrec_date.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("che_date");
		opener.document.form1.txtpredate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("che_date");
		opener.document.form1.txtchq_date.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("trn_type");
		opener.document.form1.txtrectype.value = XMLAddress1[0].childNodes[0].nodeValue;
...
function passinvresult_arr()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtChequeNo");
		opener.document.form1.txtChequeNo.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtChequeAmount");
		opener.document.form1.txtChequeAmount.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cmbBankname");
		opener.document.form1.cmbBankname.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		//XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtrctdate");
		//opener.document.form1.txtrctdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblRET_chno");
		opener.document.form1.lblRET_chno.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblretrefno");
		opener.document.form1.lblretrefno.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblretdate");
		opener.document.form1.lblretdate.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblnoof");
		opener.document.form1.lblnoof.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("cheq_dpo_bank");
		opener.document.form1.cheq_dpo_bank.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("retcou");
		opener.document.form1.txtretcount.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("orginial");
		opener.document.form1.txtoriginal.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		
		/*XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lblReciptNo");
		if (XMLAddress1[0].childNodes[0].nodeValue!=""){
			opener.document.form1.lblReciptNo.value = XMLAddress1[0].childNodes[0].nodeValue;
		}*/
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("bank_st_date");
		opener.document.form1.bank_st_date.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		opener.document.form1.mcount.value = XMLAddress1[0].childNodes[0].nodeValue;
