...
//		document.getElementById('invno1').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("disitem");
        document.getElementById('disitem').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("active_t1");
...
//		document.getElementById('invno1').value = XMLAddress1[0].childNodes[0].nodeValue;
        ...
        // XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("disitem");
        // opener.document.form1.disitem.value = XMLAddress1[0].childNodes[0].nodeValue;
