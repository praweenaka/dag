...
{   
			...
			var url="search_ret_chq_data.php";			
...
function passinvresult_arr()
{
	...
	if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
	{
		...
		opener.document.form1.txt_stat.value ="";
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtRetChCha");
		opener.document.form1.txtRetChCha.value = XMLAddress1[0].childNodes[0].nodeValue;
		...
		opener.document.form1.com_dep.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtforwhat");
		opener.document.form1.txtforwhat.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtcrenoteno");
		opener.document.form1.txtcrenoteno.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("txtcrenoteamo");
		opener.document.form1.txtcrenoteamo.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("depobank");
		opener.document.form1.cheq_dpo_bank.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		opener.document.form1.txt_stat.value="EDIT";
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("dev");
		var dev = XMLAddress1[0].childNodes[0].nodeValue;
		
		if (dev=="0"){
			opener.document.form1.op_computer.checked=true;
		} else {
			opener.document.form1.op_computer.checked=false;	
		}
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("lab_cancel");
		window.opener.document.getElementById('lab_cancel').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;
		...
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("retcout");
		opener.document.form1.txtretcount.value = XMLAddress1[0].childNodes[0].nodeValue;
		
		XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("pdno");
