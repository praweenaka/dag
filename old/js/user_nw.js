	...
	var XMLAddress1;
		...
		if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
		 { 
			...
			}else if (val=="Your Password Has Expired"){
							alert(xmlHttp.responseText);
                            location.href="change_pass.php?user_nm=" + document.getElementById('txtUserName').value ;
		...
		/*	//if (xmlHttp.responseText=="Invalied Connection"){
			...
			if(val!="0"){
				//location.href="home.php";	
				location.href="http://web/ben/home.php?un="+val;
			}
			else
			{
			//alert(xmlHttp.responseText);
...
function load_lo()
{
	//alert("http://lotterix.biz/ben");
	//location.href="http://lotterix.biz/ben";
	//location.href="http://web/van";
}
