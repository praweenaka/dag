...
function itno_undeliver_result()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (XMLAddress1[0].childNodes[0].nodeValue !="invoice") {
            ...
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("stname");
            if (XMLAddress1[0].childNodes[0].nodeValue !="DEFINV") {
            ...
            window.opener.document.getElementById('itemdetail').innerHTML = XMLAddress1[0].childNodes[0].nodeValue;     
            }
        }else{
            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("str_code");
            ...
            opener.document.form1.qty.value="";
            opener.document.form1.subtotal.value="";
            opener.document.form1.discountper.value="0";
        }
