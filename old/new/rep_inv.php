...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body><center>
            ...
            <table width="922" height="434" border="0">
                ...
                <tr>
                    <td width="10" height="21" align="left"><span class="style2"><?php echo $rtxtSupCode; ?></span></td>
                ...
                <tr><td colspan="7" valign="top">
                        <table width="900" border="0">
                            ...
                            <tr>
                                ...
                                ?></td>
                                <td width="144"><span class="style2"><?php echo $txtspdis; ?></span></td>
                                <td width="114" align="right"><span class="style2"><?php
                                        if ($txtdis2 > 0) {
