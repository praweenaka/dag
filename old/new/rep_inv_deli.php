    ...
    <body><center>
            ...
            <table width="922" height="434" border="0" >
                ...
                <tr style="visibility: hidden">
                    ...
                    <td width="85">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td colspan="3"><span class="style2"><?php echo $txtcomvat; ?></span>&nbsp;&nbsp;&nbsp;<span class="style2"><?php echo $txtoursvat; ?></span></td>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr style="visibility: hidden">
                    <td height="21">&nbsp;</td>
                    <td  style="vertical-align: text-top;" height="21" rowspan='3' colspan="4"><span class="style2"><?php
				...
				<td width=70 align=\"right\"><span class=\"style3\">" . number_format($row1["Print_dis1"], 3, ".", ",") . "</span></td>";
			...
			<td align=\"right\"><span class=\"style3\">AD</span></tr>";
				...
				<td width=70 align=\"right\"><span class=\"style2\">" . number_format($row1["Print_dis1"], 3, ".", ",") . "</span></td>";
                                    $discount1 = $PRICE * $row1["QTY"] * $row1["Print_dis1"] / 100;
                                    $subtot = ($PRICE * $row1["QTY"]) - $discount1;
                        ...
                        <table width="900" border="0">
                            ...
                            <tr style="visibility: hidden">
                                ...
                                <td rowspan="2" colspan="2"><?php
                                    if ($row['transp'] != "0" and $row['transp'] != "NORMAL") {
                                        echo "<h1>" . $row['transp'] . "</h1>";
                                    }
                                    ?>
                                </td>
                            ...
                            <tr>
                                <?php
                                if ($_GET["delivachk"] == "Y") {
                                    echo "<td colspan = '3' style = 'color: black'>Delivary to&nbsp; " . $row['deli_name'] . "</td>";
                                } else {
                                    echo "<td colspan = '3'>&nbsp;</td>";
                                }
                                ?> 
                                <!--<td colspan="3" style="color: black">Delivary to&nbsp;<?php // echo $row['deli_name']  ?></td>-->
                                 
                                <!--<td colspan="2">&nbsp;</td>-->
                                  <td>&nbsp;</td>


                                <td style="visibility: hidden" colspan="2"><span class="style2"><?php echo $txtsubtotdes; ?></span></td>
                                <td style="visibility: hidden" align="right"><span class="style2"><?php
                                        if ($txtsubtot > 0) {
                            ...
                            <tr >
                               ...
                               <td colspan="3" style="color: black"><?php echo $row['deli_add'] ?></td>
                                <td>&nbsp;</td>
                                <td colspan="2">&nbsp;</td>
                                <td style="visibility: hidden" colspan="2"><span class="style2"><?php echo $RTXTVAT ; ?></span></td>
                                <td style="visibility: hidden" align="right"><span class="style2"><?php
                                        if ($RTXVATAMU > 0) {
