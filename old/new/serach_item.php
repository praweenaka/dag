...
<body>
 ...
 <div class="checkbox">
            <label class="col-sm-3 pull-right"><input onclick="update_list('$stname', '$stname');" id="chk_stockall" type="checkbox" value="">All Item</label>
            <label class="col-sm-3 pull-right"><input onclick="update_list('$stname', '$stname');" id="chk_stock" type="checkbox" value="">Stock Item Only</label>
        </div>
...
$stname = "";
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<tr>                
                              ...
                              <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "','" . $stname . "');\">".$row['PART_NO']."</a></td>
							  <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "','" . $stname . "');\">".$row['BRAND_NAME']."</a></td>
							  <td onclick=\"itno_undeliver('" . $row['STK_NO'] . "','" . $stname . "');\">".$row['SELLING']."</a></td>
