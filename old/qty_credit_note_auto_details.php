...
<form name="form1" id="form1">
  ...
  <tr>
    <td width="15%"> <input id="dtfrom" name="dtfrom" onfocus="load_calader('dtfrom')" type="text"  value="" class="text_purchase3" /></td>
	<td width="15%"> <input id="dtto" name="dtto"  onfocus="load_calader('dtto')" type="text"  value="" class="text_purchase3" /></td>
    <td  width="30%">&nbsp;</td>
    ...
    <td  width="16%"><font color="#FFFFFF">
     ...
     <td width="25%" colspan="3"><div class="style1" id="wait_res"> </div></td>
    </tr>
    <script type="text/javascript">
	window.onload = function(){
		new JsDatePick({
