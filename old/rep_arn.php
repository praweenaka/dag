    ...
    <td colspan="4"><table width="1200" border="1" cellpadding="0" cellspacing="0">
     ...
     <?php
      ...
      echo "<tr>
		...
		if (($row2['REC_QTY'] > 0) and ($row2['acc_cost'] > 0) and ($row2['SELLING'] > 0)) {
					$stot = $row2['REC_QTY']* $row2['acc_cost'];
					$margine_val = ($row2['SELLING'] - $row2['acc_cost']) / $row2['acc_cost'] * 100;
		...
		<td align=right>".number_format($row2["acc_cost"], 2, ".", ",")."</td>
		<td align=right>".number_format($margine_val, 2, ".", ",")."</td>
		<td align=right>".number_format($row2["SELLING"], 2, ".", ",")."</td>
		<td align=right>".number_format(($row2["acc_cost"]*$row2["REC_QTY"]), 2, ".", ",")."</td>
		
      </tr>";
	  	$tot=$tot+($row2["acc_cost"]*$row2["REC_QTY"]);
	  }
      ?>
      ...
      <tr>
        ...
        <th width="212" scope="col"><?php  echo number_format($tot, 2, ".", ","); ?></th>
      </tr>
    </table></td>
  </tr>
  <tr>
