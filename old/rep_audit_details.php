...
<fieldset>
    <legend>
        <div class="text_forheader">Details</div>
    </legend>             

    <form id="form1" name="form1" action="report_audit_trail.php" target="_blank" method="get">
        <table border="0">
 ...
 <tr>
                ...
                <td><input type="text" disabled="disabled" value="Ref No" class="label_purchase"></td>
                <td><input type="text"   class="text_purchase4" id="refno" name="refno" globalnumber="334"></td>
