...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Cheque Report</div>
                                               	 </legend>             
...
<table width="767" border="0">
  ...
  <tr>
    ...
    <td width="210" align="left"><input type="text"  class="label_purchase" value="Date To" disabled="disabled"/></td>
    <td width="160"><input type="text" size="20" name="dtto" id="dtto" value="<?php echo date("Y-m-d"); ?>" onfocus="load_calader('dtto');" class="text_purchase4"/></td>
    <td width="198">&nbsp;</td>
    <td width="399">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left"><input type="radio" name="radio" id="opdatewise" checked="checked" value="radio" />
      Date Wise</td>
    <td align="left"><input type="radio" name="radio" id="op_bankwise" value="radio" />
Bank Wise</td>
    <td align="left">&nbsp;</td>
    <td colspan="2" align="left"><input type="radio" name="radio" id="op_dtreport" value="radio" /> 
      Detailed Report
</td>
  </tr>
