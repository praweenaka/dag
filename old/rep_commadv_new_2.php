...
$txttyres1 = $row['tar_salc'];
$txttyresc1 = $row['tar_salcom'];
...
$txtbatnsc = $row['Com_tube'];
  ...
  <tr>
   ...
   <tr>
    <td width="254"><span class="style1"></span></td>
    <td width="177">Cat 2.</td>
    <td align="right" width="125"><?php echo number_format($txttyres1, 2, ".", ","); ?></td>
    <td align="right" width="226"><?php echo number_format($txttyresc1, 2, ".", ","); ?></td>
  </tr>
  ...
  <tr>
    ...
    <td>Cat 2.</td>
    <td align="right"><?php echo number_format($txtbats1, 2, ".", ","); ?></td>
    <td align="right"><?php echo number_format($txtbatsc1, 2, ".", ","); ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>No Commision</td>
  ...
  <tr>
   ...
   <tr>
    ...
    <td></td>
    <td align="right"><span class="style1"><?php echo number_format(($txttyresc + $txttyrensc + $txtbatsc + $txtbatnsc+$txttyresc1+$txtbatsc1), 2, ".", ","); ?></span></td>
  </tr>  
  <?php
$mgross = ($txttyresc + $txttyrensc + $txtbatsc + $txtbatnsc+$txttyresc1+$txtbatsc1);
 ?>
     <tr>
