...
<table width="767" border="0">
  ...
  <td width="150" align="left"><input type="text"  class="label_purchase" value="Marketing Executive" disabled="disabled"/></td>
  ...
  <td width="150" align="left"><input type="text"  class="label_purchase" value="District" disabled="disabled"/></td>
    <td colspan="2" align="left"><select name="district" id="district" class="text_purchase3">
        <option value='All'>All</option>
          <?php
            $sql="select district from district_town_master group by district";
            $result =mysqli_query($GLOBALS['dbinv'],$sql) ; 
            while($row = mysqli_fetch_array($result)){
    ...
    <td colspan="3" align="left"><table width="500" border="0">
      <tr>
        <th width="459" scope="col"><table width="400" border="0">
          <tr>
            <th scope="col"><input type="radio" name="radio" id="optallcus" value="optallcus"  />
              All Customer List</th>
            <th scope="col"><input type="radio" name="radio" id="optexistcus" value="optexistcus" checked="checked"/>
              Existing Customer</th>
            </tr>
