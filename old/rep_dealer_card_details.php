...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Dealer Card Report</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_dealer_card.php" target="_blank" method="get">
<table width="767" border="0">
  ...
  <tr>
    ...
    <td width="209"><input type="text" name="cusname" id="cusname" class="text_purchase3"/>    
    </td>
    <td width="209"><a href="serach_customer.php?stname=rep_dealercard" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
  ...
  <tr>
    <td align="left"><p>
        ...
        <input type="radio" name="radio" checked="checked" value="Option1" id="Option1" />
        Daily
      <label>        </label>
      <br />
    </p></td>
    <td align="left"><input type="radio" name="radio" value="Option2" id="Option2" />
      Period</td>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="186" align="left"><input type="text" size="20" name="dtfrom" id="dtfrom" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3" onfocus="load_calader('dtfrom')" /></td>
    <td width="209" align="left"><input type="text" size="20" name="dtto" id="dtto" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3" onfocus="load_calader('dtto')"/></td>
