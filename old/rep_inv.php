...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body><center>
            ...
            <table width="922" height="434" border="0">
				...
				<td width=70 align=\"right\"><span class=\"style3\">" . number_format($row1["Print_dis1"], 2, ".", ",") . "</span></td>";
			...
			<td align=\"right\"><span class=\"style3\">AD</span></tr>";
				...
				<td width=70 align=\"right\"><span class=\"style2\">" . number_format($row1["Print_dis1"], 2, ".", ",") . "</span></td>";
                                    $discount1 = $PRICE * $row1["QTY"] * $row1["Print_dis1"] / 100;
                                    $subtot = ($PRICE * $row1["QTY"]) - $discount1;
