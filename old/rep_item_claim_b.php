...
<table width="1000" border="0">
  ...
  <tr>
    <td colspan="5" align="center"><span class="companyname">UNDER COMPLAINT BATTERY REPORT</span></td>
  </tr>
   <?php
		//echo $_GET["invno"];
		...
		if (trim($_GET["txtCRD_no3"]) != "0" and trim($_GET["txtCRD_no3"]) != "") {
    		...
    		$d = date("d");
    			...
    			for ($i = 1; $i<= 6; $i++){
	        		...
	        		if ($i == 1) {
    	        		...
    	        		if (is_null($row_rs_sal["S_TOT"])==false) { $sale = $sale + $row_rs_sal["S_TOT"]; }
	            		if (is_null($row_rs_cbal["G_TOT"])==false) { $grn = $grn + $row_rs_cbal["G_TOT"]; }
    	        		$Text48= $Mon;
  ...
  <tr>
    ...
    <th colspan="4" scope="col" align="center"><table width="800" border="1" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><?php if ($row_rsPrInv["entdate"]!="0000-00-00"){echo $row_rsPrInv["entdate"]; } ?></td>
        <td align="center"><?php 
   ...
   <?php
    ...
    $diff = abs(strtotime($row_rsPrInv["recieve_date"]) - strtotime($row_rsPrInv["Sold_date"]));
    $days = floor($diff / (60*60*24*30));
    

    $diff = abs(strtotime($row_rsPrInv["recieve_date"]) - strtotime($row_rsPrInv["Sold_date_c"]));
    ...
    <table class="tb" >
      <tr>
        <td  class="tb"></td>
        <td class="tb">Dealer</td>
        <td class="tb">Customer</td>
      </tr>
      
      <tr>
        <td class="tb" align="center">Purchase Date</td>
        <td  class="tb" align="center"><?php echo $row_rsPrInv["Sold_date"]; ?></td>
        <td class="tb" align="center"><?php echo $row_rsPrInv["Sold_date_c"]; ?></td>
      </tr>
      
      <tr>
        <td  class="tb" align="center">Usage/Months</td>
        <td class="tb" align="center"><?php echo ($days+1); ?></td>
        <td  class="tb" align="center"><?php echo ($days1+1); ?></td>
      </tr>      
      ...
      <tr>
        <th width="801" rowspan="4" scope="col"><table width="800" border="1" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><?php echo $row_rsPrInv["Cell1_el"]; ?></td>
            <td><?php echo $row_rsPrInv["Cell2_el"]; ?></td>
            <td><?php echo $row_rsPrInv["Cell3_el"]; ?></td>
            <td><?php echo $row_rsPrInv["Cell4_el"]; ?></td>
            <td><?php echo $row_rsPrInv["Cell5_el"]; ?></td>
            <td><?php echo $row_rsPrInv["Cell6_el"]; ?></td>
            <th>OCV</th>
			<th>CCA</th>
            <th scope="col">Refund %</th>
          </tr>
          <tr>
            <td align="left">Initial SPG</td>
            <td><?php echo intval($row_rsPrInv["Cell1_Ispg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell2_Ispg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell3_Ispg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell4_Ispg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell5_Ispg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell6_Ispg"]); ?></td>
            <td><?php echo $row_rsPrInv["OCV2"]; ?></td>
			<td><?php echo $row_rsPrInv["CCA2"]; ?></td>
            <td rowspan='2' scope="col"><?php echo $row_rsPrInv["rem_per"]; ?></td>
          </tr>
          <tr>
            <td align="left">After Charge SPG</td>
            <td><?php echo intval($row_rsPrInv["Cell1_Aspg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell2_Aspg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell3_Aspg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell4_Aspg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell5_Aspg"]); ?></td>
            <td><?php echo intval($row_rsPrInv["Cell6_Aspg"]); ?></td>
            <td><?php echo $row_rsPrInv["OCV3"]; ?></td>
			<td><?php echo $row_rsPrInv["CCA3"]; ?></td>
            </tr>
        </table></th>
        <th scope="col"><?php if ($_GET["Prn_md"]=="true"){ echo "Commercially Allowed"; }?></th>
      </tr>
      <tr>
        <th width="189" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <td><?php if ($_GET["Prn_md"]=="true"){ echo "___________________________"; } ?></td>
      </tr>
      <tr>
        <td align="center"><?php if ($_GET["Prn_md"]=="true"){echo "Managing Director";} ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php if ($row_rsPrInv["gatepass"]!="0000-00-00"){echo $row_rsPrInv["gatepass"];} ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>Return Date :</td>
    <td><?php if ($row_rsPrInv["returndate"]!="0000-00-00"){echo $row_rsPrInv["returndate"];} ?></td>
  </tr>
  <tr>
    <td colspan="4">
...
if ($_GET["Prn_md"]=="true"){
  ...
  <tr>
    <td colspan="4">Note Well : The Company reserve the right to destroy Non Refundable rejected batteries that are not removed within 30 days from the date here of</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td></td>
