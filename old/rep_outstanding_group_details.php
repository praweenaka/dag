...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Outstanding Statement Group Status</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_outstanding_group.php" target="_blank" method="get">
<table width="767" border="0">
  ...
  <tr>
    <td colspan="2" align="left"><input type="text"  class="text_purchase3"  disabled="disabled" id="cus_address" name="cus_address" /></td>
  </tr>
    ...
    <tr>
   <th scope="col"><input type="radio" name="radio" id="optsum" value="optsum" >
Summery</th>
<th scope="col"><input type="radio" name="radio" id="optdet" value="optdet" checked="checked">
Detail</th>
<td>&nbsp;</td>
  </tr>
