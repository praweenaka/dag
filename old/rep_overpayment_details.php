...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Over Payment Report</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_overpayments.php" target="_blank" method="get">
<table width="767" border="0">
  ...
  <tr>
    ...
    <td align="left"><input type="radio" name="radio" value="optperiod" id="optperiod" checked="checked"  onclick="utility_chk();"/>
      Period</td>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td width="209" align="left"><input type="text" size="20" name="dtto" id="dtto" onfocus="load_calader('dtto');" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3" /></td>
