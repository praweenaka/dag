...
<fieldset>
    <legend>
        <div class="text_forheader">Pending Orders</div>
    </legend>             

    <form id="form1" name="form1" action="report_pending_orders.php" target="_blank" method="get">
        <table border="0">
            ...
            <tr>
                ...
                <td><input type ='radio' name ='ordt' selected='true' id='ordt' value='brand'>Brand  </td>
                <td></td>
                <td>
                    <select name="cmbbrand" id="cmbbrand" onkeypress="keyset('brand', event);" class="text_purchase3">
                        

                        <?php
                        $sql = "select * from brand_mas where barnd_name <> '' order by barnd_name";
                        $result = mysqli_query($GLOBALS['dbinv'],$sql) ; 
            ...
            <tr>
                <td><input type ='radio' name ='ordt' id='ordt' value='type'>Group  </td>
                <td></td>
                <td>
                    <select name="cmbordt" id="cmbordt" onkeypress="keyset('brand', event);" class="text_purchase3">
