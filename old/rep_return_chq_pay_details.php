...
<form id="form1" name="form1" action="report_return_chq_pay.php" target="_blank" method="get">
<table width="767" border="0">
  <tr>
    ...
    <td colspan="2" align="left"><select name="Com_rep" id="Com_rep" onkeypress="keyset('dte_dor',event);"  class="text_purchase3">
