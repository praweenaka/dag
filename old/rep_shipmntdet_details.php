...
<fieldset>
    <legend>
        <div class="text_forheader">Shipment Details</div>
    </legend>             

    <form id="form1" name="form1" action="report_shipmntdet.php" target="_blank" method="get">
        <table border="0">
            ...
            <tr>
                ...
                <td><input type="text" disabled="disabled" value="Type" class="label_purchase"></td>
                <td>  
                    <select name="cmbcat" id="cmbcat" onkeypress="keyset('brand', event);" class="text_purchase3">
