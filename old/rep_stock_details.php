...
<table width="767" border="0">
  <tr>
    <td width="274" align="left"><table width="226">
      <tr>
        <td width="76" align="left">Brand</td>
        <td width="138"><select name="brand" id="brand" onkeypress="keyset('brand',event);" onchange="setlist();"  class="text_purchase3">
    ...
    <td width="200"><table>
      <tr>
        ...
        <td width="106"><select name="department" id="department" onkeypress="keyset('brand',event);" class="text_purchase3">
            <?php
    ...
    <td width="279"><table>
      <tr>
        ...
        <td width="167"><select name="stype" id="stype" onkeypress="keyset('brand',event);" class="text_purchase3">
         <?php if ($_SESSION["CURRENT_REP"]=="") { ?> <option value='Cost'>Cost</option>   <?php } ?>
  ...
  <tr>
    ...
    <td colspan="1"><select name="cmb_t" id="cmb_t" class="text_purchase3">
					 
						
            <?php
            if ($_SESSION["department"] != "") {
                $sql = "select costcenter from brand_mas where act='1' and costcenter='".$_SESSION["department"]."' group by costcenter";
                $result = mysqli_query($GLOBALS['dbinv'], $sql);
                while ($row = mysqli_fetch_array($result)) {
            ...
            ?>	
                                 ...
                                 <td width="174" align="center" ><input  type="checkbox" name="lockite" id="lockite" /> Locked Items </td>
  </tr>
