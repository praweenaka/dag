...
<table width="767" border="0">
  ...
  <tr>
    <td colspan="5" align="left"><input type="checkbox" name="chk_lastyear" id="chk_lastyear" /> Last Year</td>
  </tr>
  <tr>
    <td align="left"><input type="radio" name="radio" id="op_sumexpo" checked="checked" value="radio" />
      Summery</td>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
    <td colspan="2" align="left">&nbsp;</td>
