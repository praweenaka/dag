...
<title>Unsold Report</title><fieldset>
                                                	<legend>
  <div class="text_forheader">Unsold Stock Report</div>
                                               	 </legend>             

<form id="form1" name="form1" action="report_unsold.php" target="_blank" method="get">
<table width="767" border="0">
  <tr>
    <td width="274" align="left"><table width="274">
      <tr>
        <td width="76" align="left">Brand</td>
        <td width="186"><select name="cmbbrand" id="cmbbrand" onkeypress="keyset('brand',event);" onchange="setord();" class="text_purchase3">
    ...
    <td width="122" align="right">Day &gt;</td>
    <td width="234"><input type="text" name="over" id="over" value="0" />      </td>
  </tr>
  <tr>
    <td width="274" align="left"></td>
    <td align="right">&nbsp;</td>
    <td align="right">&lt;</td>
    <td><input type="text" name="between" id="between" value="0" /></td>
  </tr>
  <tr>
    <td colspan="4" align="left"><label>
      ...
      Details</label>
        ...
        <input type="radio" name="unsold" value="summery" id="unsold_1" />
          Summery</label>
      <label>
        <input type="radio" name="unsold" value="stock" id="unsold_2" />
        Stock Report</label>
        <label>
                                        <input type="radio" name="unsold" value="DetailLess" id="unsold_3" />
                                        Detail Less</label>
  ...
  <tr>
    <td width="274" align="left"></td>
    <td colspan="3"><input type="submit" name="button" id="button" value="View" class="btn_purchase1"/></td>
  </tr>
</table>
<fieldset>               
