...
<form id="form1" name="form1" action="report_yearly_sales.php" target="_blank" method="get">
...
Customer</td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="month1" id="month1" required class="text_purchase3" onfocus="load_calader('month1');" /></td>
    <td align="left"><input type="text" name="month12" id="month12" required class="text_purchase3" onfocus="load_calader('month12');" /></td>
    <td align="left"></td>
  </tr>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="month2" id="month2" required class="text_purchase3" onfocus="load_calader('month2');"/></td>
    <td align="left"><input type="text" name="month22" id="month22" required class="text_purchase3" onfocus="load_calader('month22');"/></td>
    <td align="left">&nbsp;</td>
  </tr>
  <tr>
    <td align="left">&nbsp;</td>
    ...
    <td align="left"><input type="text" name="month3" id="month3" required class="text_purchase3" onfocus="load_calader('month3');"/></td>
    <td align="left"><input type="text" name="month32" id="month32" required class="text_purchase3" onfocus="load_calader('month32');"/></td>
    <td align="left">&nbsp;</td>
  </tr>
  
  <tr>
    <td align="left"><input type="text"  class="label_purchase" value="District" disabled="disabled"/></td>
    <td align="left">&nbsp;</td>
    <td align="left"><select name="cmbdistrict" id="cmbdistrict" onkeypress="keyset('searchitem',event);" class="text_purchase3"  onchange="setord();">
      <option value='All'>All</option>
      <?php 
                $sql="select district from vendor group by district";
                $result =mysqli_query($GLOBALS['dbinv'],$sql) ; 
                while($row = mysqli_fetch_array($result)){
echo "<option value='".$row["district"]."'>".$row["district"]."</option>";
    ...
    <tr>
    <td align="left"><input type="text"  class="label_purchase" value="Province" disabled="disabled"/></td>
    <td align="left">&nbsp;</td>
    <td align="left"><select name="cmbprovince" id="cmbprovince" onkeypress="keyset('searchitem',event);" class="text_purchase3"  onchange="setord();">
      <option value='All'>All</option>
      <?php
	  		  
            $sql="select province from vendor group by province";
            $result =mysqli_query($GLOBALS['dbinv'],$sql) ; 
            while($row = mysqli_fetch_array($result)){
