...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
		...
		if ($_GET["radio"]=="optallcus"){
			
			if ($_GET["chkprintable"]=="on"){
            	...
            	echo "<center><table width=1000 border=0>";
		  		...
		  		$i=1;
            	$sql_cus = "select * from vendor  where code<> ''";
				
				if ($_GET['district'] != "All") {
					
					$sql_cus .= " and district = '" . $_GET['district'] . "'"; 
					
				}

					
				$sql_cus .=  " order by code";
				...
				while ($row_cus = mysqli_fetch_array($result_cus)) {
					...
					if ($_GET["cmbrep"]=="All"){
            			...
            			echo "<table>";
						echo "<tr><td>".$row_cus["NAME"] . "</td></tr>";
						echo "<tr><td>".$row_cus["ADD1"] . "</td></tr>";
						echo "<tr><td>".$row_cus["ADD2"] . "</td></tr>";
						echo "</table>";
						...
						$sql_cus1 = "select * from br_trn where cus_code='".$row_cus["CODE"]."' and Rep='".$_GET["cmbrep"]."'";
						$result_cus1 = mysqli_query($GLOBALS['dbinv'],$sql_cus1);
						if($row_cus1 = mysqli_fetch_array($result_cus1)) {
	...
	<td  width=\"600\" align=center><b>Customer Master Details</b></td>
		...
		if ($_GET["radio"]=="optexistcus"){
			...
			if ($_GET["chkprintable"]=="on"){
				...
				$sql_cus = "select * from vendor where  CAT!='D' ";
				...
				while ($row_cus = mysqli_fetch_array($result_cus)) {
					...
					if ($_GET["cmbrep"]=="All"){
						$sql_cus1 = "select * from br_trn where cus_code='".$row_cus["CODE"]."' and CAT!='' and CAT!='D' and credit_lim>0 ";
					} else {
						$sql_cus1 = "select * from br_trn where cus_code='".$row_cus["CODE"]."' and CAT!='' and CAT!='D' and Rep='".$_GET["cmbrep"]."' and credit_lim>0";
					}	
            		$result_cus1 = mysqli_query($GLOBALS['dbinv'],$sql_cus1);
					if($row_cus1 = mysqli_fetch_array($result_cus1)) {
