    ...
    <body>
        ...
        function nilsal() {
            ...
            while ($row_v = mysqli_fetch_array($result_v)) {
                ...
                $strinv = "select sum(grand_tot/(1 +gst/100)) as gtot,brand,c_code,month(sdate1) as month ,year(sdate1) as year from s_salma where ACCNAME <> 'NON STOCK'   and CANCELL='0' ";
                if ($_GET["cmbrep"] != "All") {
                ...
                $strinv .= " and (( month(sdate1) = '" . $month1 . "'  and year(sdate1) = '" . $month1_y . "') ";
                $strinv .= " or ( month(sdate1) = '" . $month2 . "'  and year(sdate1) = '" . $month2_y . "') ";
                $strinv .= " or ( month(sdate1) = '" . $month3 . "'  and year(sdate1) = '" . $month3_y . "')) ";
                $strinv .= "  group by brand,c_code,year(sdate1), month(sdate1) ";

                $result2 = mysqli_query($GLOBALS['dbinv'], $strinv);
                $nmr = mysqli_num_rows($result2);

                $strgrn = "select sum(amount/(1 +vatrate/100)) as gtot,CUSCODE,brand,month(sdate1) as month ,year(sdate1) as year from c_bal where  trn_type<>'INC'and trn_type<>'REC' and trn_type<>'PAY' and trn_type<>'ARN'  and flag1 <> '1'";
                if ($_GET["cmbrep"] != "All") {
                ...
                $strgrn .= " and (( month(sdate1) = '" . $month1 . "'  and year(sdate1) = '" . $month1_y . "') ";
                $strgrn .= " or ( month(sdate1) = '" . $month2 . "'  and year(sdate1) = '" . $month2_y . "') ";
                $strgrn .= " or ( month(sdate1) = '" . $month3 . "'  and year(sdate1) = '" . $month3_y . "')) ";
                $strgrn .= "  group by brand,CUSCODE,year(sdate1), month(sdate1) ";
...
//echo $sql_itclas;
                ...
                if ($yy == "y") {
                    ...
                    if ($_GET["chkdevelo_cus"] == "on") {
                        if ($cat == "Z") {
                            $usr[] = "('" . $row_RSINVO01['c_code'] . "', '" . $row_rsVENDOR["NAME"] . "', '" . $lmt . "', '" . $cat . "', '" . ($mon1 - $Gmon1) . "', '" . ($mon2 - $Gmon2) . "', '" . ($mon3 - $Gmon3) . "', '" . $row_rsVENDOR["cus_type"] . "' , '" . $row_RSINVO01['brand'] . "', '" . $_SESSION["CURRENT_USER"] . "' )";
                        }
                    } else {
                        $usr[] = "('" . $row_RSINVO01['c_code'] . "', '" . $row_rsVENDOR["NAME"] . "', '" . $lmt . "', '" . $cat . "', '" . ($mon1 - $Gmon1) . "', '" . ($mon2 - $Gmon2) . "', '" . ($mon3 - $Gmon3) . "', '" . $row_rsVENDOR["cus_type"] . "' , '" . $row_RSINVO01['brand'] . "', '" . $_SESSION["CURRENT_USER"] . "' )";
                    }
...
//            echo $strgrn;
            while ($row_RSINVO01 = mysqli_fetch_array($result2)) {
                ...
                if ($_GET["radio"] == "op_traget") {
                    ...
                    $result_itclas = mysqli_query($GLOBALS['dbinv'], $sql_itclas);
//echo "mysqli_num_rows($result_itclas";
                    if (mysqli_num_rows($result_itclas) > 0) {
                        $yy = "y";
                    }
                } else {
                ...
                if ($yy == "y") {
                    ...
                    if ($_GET["chkdevelo_cus"] == "on") {
                        if ($cat == "Z") {
                            $usr1[] = "('" . $row_RSINVO01['CUSCODE'] . "', '" . $row_rsVENDOR["NAME"] . "', '" . $lmt . "', '" . $cat . "', '" . ($mon1 - $Gmon1) . "', '" . ($mon2 - $Gmon2) . "', '" . ($mon3 - $Gmon3) . "', '" . $row_rsVENDOR["cus_type"] . "' , '" . $row_RSINVO01['brand'] . "', '" . $_SESSION["CURRENT_USER"] . "' )";
                        }
                    } else {
                        $usr1[] = "('" . $row_RSINVO01['CUSCODE'] . "', '" . $row_rsVENDOR["NAME"] . "', '" . $lmt . "', '" . $cat . "', '" . ($mon1 - $Gmon1) . "', '" . ($mon2 - $Gmon2) . "', '" . ($mon3 - $Gmon3) . "', '" . $row_rsVENDOR["cus_type"] . "' , '" . $row_RSINVO01['brand'] . "', '" . $_SESSION["CURRENT_USER"] . "' )";
                    }
		...
		<th>3 Month Total</th>
            ...
            while ($row_sql = mysqli_fetch_array($result_sql)) {
				...
				<td>" . $row_sql["cus_name"] . "</td>";
                    if ($row_sql["limit1"] != "") {
                        echo "<td align=\"right\">" . number_format($row_sql["limit1"], 0, ".", ",") . "</td>";
                    } else {
...
//                 echo $sql_sql1;
                    ...
                    while ($row_sql1 = mysqli_fetch_array($result_sql1)) {
                        ...
                        if ($_GET["cmbrep"] != "All") {
                            ...
                            $sql_oothinv = "select sum(grand_tot/(1 +gst/100)) as gtot,brand,c_code,month(sdate1) as month ,year(sdate1) as year from s_salma where ACCNAME <> 'NON STOCK'   and CANCELL='0' ";
                            ...
                            $sql_oothinv .= " and (( month(sdate1) = '" . $dmonth1 . "'  and year(sdate1) = '" . $dmonth1_y . "')";
                            $sql_oothinv .= " or ( month(sdate1) = '" . $dmonth2 . "'  and year(sdate1) = '" . $dmonth2_y . "')";
                            $sql_oothinv .= " or ( month(sdate1) = '" . $dmonth3 . "'  and year(sdate1) = '" . $dmonth3_y . "'))";
                            $sql_oothinv .= "  group by brand,c_code,year(sdate1), month(sdate1) ";
                            ...
                            $sql_oothgrn = "select sum(amount/(1 +vatrate/100)) as gtot,CUSCODE,brand,month(sdate1) as month ,year(sdate1) as year from c_bal where  trn_type<>'INC'and trn_type<>'REC' and trn_type<>'PAY' and trn_type<>'ARN'  and flag1 <> '1'";
...
//                        $sql_headbrandmas = "select * from brand_mas";
//                        $result_brandmas  = mysqli_query($GLOBALS['dbinv'], $sql_headbrandmas);
//                        $row_brandmas  = mysqli_fetch_array($result_brandmas);
