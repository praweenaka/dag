...
/////////// Sales Summery////////////////////////////////////////
			...
			if ($_GET["chkpe"] != "on") {
				if ($_GET["cmbdev"] == "All"){
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0.5 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."') and CANCELL='0' ";
						
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' ";
				...
				if ($_GET["cmbdev"] == "Computer") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' ";
					}
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' ";
					}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" .$tmpdate. "'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1' ";
					}	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep. "'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1' ";
					}
				}
			}
			...
			if ($_GET["chkpe"] == "on") {
				if ($_GET["cmbdev"] == "All") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."'or SDATE='".$tmpbellow."')  and CANCELL='0' ";
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep. "'and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' ";
					}	
				}
				...
				if ($_GET["cmbdev"] == "Computer") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover ."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' ";
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' ";
					}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpover."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' ";
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						//echo "12";
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' ";
					}
				}	
			}
		}    
			...
			if ($_GET["chkpe"] != "on") {
				if ($_GET["cmbdev"] == "All") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'".$tmpdate ."' or SDATE='".$tmpdate."') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}
				}
				...
				if ($_GET["cmbdev"] == "Computer") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
					...
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' ";
					}
				}
			}
			...
			if ($_GET["chkpe"] == "on") {
				if ($_GET["cmbdev"] == "All") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
				}
				...
				if ($_GET["cmbdev"] == "Computer") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
					
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
					if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' ";
					}	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "'";
					}	
				}
			}
		}
		
		$sql .= "  order by C_CODE,c_code1, SDATE";
  ...
  //echo $sql;
	...
	//echo $rst1;
		...
		while($row = mysqli_fetch_array($result)){
			...
			if (strtoupper($row["C_CODE"])!=strtoupper($ccode)) {
				if ($i!=0){
					...
					<td colspan=1 align=right><b>".number_format($balance, 2, ".", ",")."</b></td>
					</tr>";
				} 
				$i=1;	
				...
				<th colspan=9 align=left><b>".$row["C_CODE"]." ".$row_cus["NAME"]. "    -" .$row_cus["ADD2"]."</b></th>
				</tr>";
		...
		echo "<tr>
		<td colspan=8 align=right></td>
		<td colspan=8 align=right><b>".number_format($balance, 2, ".", ",")."</b></td>
		</tr>";
		echo "<tr>
		<td colspan=8></td><td><b>".number_format($totbal, 2, ".", ",")."</b></td></tr>";
		echo "<table>";
	...
	function currentrepcus() {
		...
		if ($_GET["cmbbrand"] == "All") {
			if ($_GET["cmbdev"] == "All") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0'  ";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' ";
				}
			}

			if ($_GET["cmbdev"] == "Manual") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0' and DEV='1' ";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1'  ";
				}
			}

			if ($_GET["cmbdev"] == "Computer") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0' and DEV='0' ";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'";
				}
			}
		}
		...
		if ($_GET["cmbbrand"] != "All") {
			if ($_GET["cmbdev"] == "All") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'";
				}
			}

			if ($_GET["cmbdev"] == "Manual") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'";
				}
			}

			if ($_GET["cmbdev"] == "Computer") {
				if ($_GET["cmbrep"] == "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "'";
				}
				if ($_GET["cmbrep"] != "All") {
					$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >1 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  and Brand='" . $_GET["cmbbrand"] . "'";
				}
			}
		}

		if ($_GET["chkpe"] != "on") {
			$sql .= " and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')";
		} else {
			$sql .= " and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "' or SDATE='" . $tmpbellow . "')";
		}
		$sql .= " group by c_code";    
		
		
		$rtxtdate = "OutStanding Report On  " . $_GET["dtdate"] . " - Customer Wise";
		...
		if ($_GET["chkpe"] != "on") {
			$rtxtdate = "OutStanding Report On  " . date("Y-m-d") . "  Customer Wise     Over  " . $_GET["txtdays"] . "  Days";
		}
		if ($_GET["chkpe"] == "on") {
			$rtxtdate = "OutStanding Report On  " . date("Y-m-d") . "  Customer Wise     Over  " . $_GET["txtover"] . " and bellow " . $_GET["txtdb"] . "  Days";
		}			
