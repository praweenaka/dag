            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All"){
                   if ($_GET["cmbrep"] == "All") { 
				   		...
				   		$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."') and CANCELL='0' order by C_CODE, SDATE";
						
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
					
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' order by C_CODE, SDATE";
				...
				if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
                   	}
				   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
                	}
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" .$tmpdate. "'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
					}	
                   	if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep. "'and (SDATE<'".$tmpdate."'or SDATE='".$tmpdate."')and CANCELL='0' and DEV='1'order by C_CODE, SDATE";
                	}
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."'or SDATE='".$tmpbellow."')  and CANCELL='0' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep. "'and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' order by C_CODE, SDATE";
					}	
               }
               ...
               if ($_GET["cmbdev"] == "Computer") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover ."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
					}	
                   	
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='0' order by C_CODE, SDATE";
               		}
				}
				...
				if ($_GET["cmbdev"] == "Manual") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpover."' or SDATE='".$tmpover."') and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						//echo "12";
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='".$rep."' and (SDATE<'".$tmpover."'or SDATE='".$tmpover."')and (SDATE>'".$tmpbellow."' or SDATE='".$tmpbellow."') and CANCELL='0' and DEV='1' order by C_CODE, SDATE";
                	}
            	}	
			}
    }    
            ...
            if ($_GET["chkpe"] != "on") {
                if ($_GET["cmbdev"] == "All") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'".$tmpdate ."' or SDATE='".$tmpdate."') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                   	}
					if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                	}
               }
			   ...
			   if ($_GET["cmbdev"] == "Computer") {
                    if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                	}
				}
                ...
                if ($_GET["cmbdev"] == "Manual") {
				   ...
				   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
				   }	
                   if ($_GET["cmbrep"] != "All") { 
				   		
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
                   }
            	}
            }
			...
			if ($_GET["chkpe"] == "on") {
                if ($_GET["cmbdev"] == "All") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Computer") {
                   	if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    
					if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
                ...
                if ($_GET["cmbdev"] == "Manual") {
                   if ($_GET["cmbrep"] == "All") { 
						...
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                    if ($_GET["cmbrep"] != "All") { 
						
						$sql = "SELECT * from view_salma_vendor where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "' order by C_CODE, SDATE";
					}	
                }
            }
 	}
...
function currentrepcus()
{
	...
	if ($_GET["cmbbrand"] == "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' group by C_CODE ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' group by C_CODE";
			}
        }
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1'  group by  C_CODE ";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' group by C_CODE";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0'  group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  group by C_CODE";
			}	
        }
	}
	...
	if ($_GET["cmbbrand"] != "All") {
        if ($_GET["cmbdev"] == "All") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE" ;
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "'  group by C_CODE ";
        	}
		}
         
        if ($_GET["cmbdev"] == "Manual") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "'  group by C_CODE";
			}	
        }
         
        if ($_GET["cmbdev"] == "Computer") {
            if ($_GET["cmbrep"] == "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' group by C_CODE";
			}	
            if ($_GET["cmbrep"] != "All") { 
				$sql = "SELECT sum(grand_tot) as GRAND_TOT, sum(totpay) as TOTPAY, C_CODE from s_salma where Accname != 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and CANCELL='0' and DEV='0'  and Brand='" . $_GET["cmbbrand"] . "'   group by C_CODE";
			}	
        }
	}
...
{  
	...
	if ($_GET["cmbbrand"] == "All") {
    	if ($_GET["chkpe"] != "on") {
        	if ($_GET["cmbdev"] == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' order by SDATE";
                }
             } 
             if ($_GET["cmbdev"] = "Computer") {
             	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' order by SDATE";
				 }	
                 if ($_GET["cmbrep"] != "All") { 
				 	$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' order by SDATE";
                 }
			 }   
                
             if ($_GET["cmbdev"] == "Manual") {
             	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1'order by SDATE";
				}	
             }
        }
        ...
        if ($_GET["chkpe"] == "on") {
        	if ($_GET["cmbdev"] == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' order by SDATE";
				 }	
                 if ($_GET["cmbrep"] != "All") { 
				 	$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' order by SDATE";
				 }	
            }
               
            if ($_GET["cmbdev"] == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' order by SDATE";
				}	
            }
                
            if ($_GET["cmbdev"] == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' order by SDATE";
				}	
            }
        }
 	}
	...
	if ($_GET["cmbbrand"] != "All") {
    	if ($_GET["chkpe"] != "on") {
        	if (cmbdev == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
               
            if (cmbdev == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
                
            if (cmbdev == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpdate . "'or SDATE='" . $tmpdate . "')and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
        }
        ...
        if ($_GET["chkpe"] == "on") {
            if (cmbdev == "All") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "')  and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
               
            if (cmbdev == "Computer") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0'and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='0' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
                
            if (cmbdev == "Manual") {
            	if ($_GET["cmbrep"] == "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE>'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1' and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
                if ($_GET["cmbrep"] != "All") { 
					$sql = "SELECT * from s_salma where Accname = 'NON STOCK' and GRAND_TOT - TOTPAY >0 and SAL_EX='" . $rep . "'and (SDATE<'" . $tmpover . "'or SDATE='" . $tmpover . "')and (SDATE<'" . $tmpbellow . "'or SDATE='" . $tmpbellow . "') and CANCELL='0' and DEV='1'  and Brand='" . $_GET["cmbbrand"] . "' order by SDATE";
				}	
            }
        }
 	}
