...
<?php
		...
		$sql = "SELECT ref_no from stk_take_mas group by ref_no order by ref_no  ";
		...
		$sql = "SELECT * from stk_take_mas where ref_no= '" . trim($row1["ref_no"]) . "'  ";
		...
		echo "<center><br>";
		echo "<center><b>Page No - ".trim($row1["ref_no"])."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Location - ".$row["location"]."</b><br><br>";
		...
		//echo $sql;
		$sql = "SELECT * from view_stktake_s_mas where REF_NO= '" . trim($row1["ref_no"]) . "'  order by id ";
		$result =mysqli_query($GLOBALS['dbinv'],$sql);
