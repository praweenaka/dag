...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		if ($_GET["cmbbrand"] == "All") {
			$sql_smas = "select * from viewsubmas1 where STO_CODE='" . $_GET["com_dep"] . "' AND  QTY1> 0  limit 900";
		}
		if ($_GET["cmbbrand"] != "All") {
			...
			<table width="1200" border="1">
				<tr>
					<th>Stock No</th><th width="250">Description</th><th>Part No</th><th>Qty In Ha</th><th>No of Days</th><th>Un Sold Stock</th><th>L/C No</td> <th>AR Date</th><th>AR No</th><th>AR Qty</th>
                                        <?php if ($_SESSION["CURRENT_REP"]=="" and $_SESSION["CURRENT_DEP"]=="") echo "<th>Total Value</th><th>Cost Value</th><th>Unsold Value</th>";?>
				</tr>
				<?php
				$brand = "";
				$STK_NO = "";
...
<td align=\"left\" colspan=13><b>" . $rows["brand"] . "</b></td></tr>";
				...
				?>
                        ...
                        <?php if ($_SESSION["CURRENT_REP"]=="" and $_SESSION["CURRENT_DEP"]==""){?>
			<table width='1200'>
				<tr>
