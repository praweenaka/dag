...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td><input type="text" size="20" name="invdate" id="invdate" value="<?php echo date("Y-m-d"); ?>" class="text_purchase3"/></td>
  ...
  <tr>
    ...
    <td><a href="serach_rec_settle.php?stname=cash_rec" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
  ...
  <tr>
    <td><input type="text"  class="label_purchase" value="Doc Ref No" disabled="disabled"/></td>
    <td><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="cashtt" id="cashtt" size="10" onkeypress="keyset('chqdate',event);"  value=""    />
    </font></font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Debit Account" disabled="disabled"/></td>
    <td><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="accno" id="accno" size="10" value="" onkeypress="keyset('chqdate',event);"     />
    </font></font></td>
    <td colspan="2"><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" size="10" id="acc_name" name="acc_name" value="" onkeypress="keyset('bank',event);" />
    </font></font></td>
  ...
  <tr>
    <td><input type="text"  class="label_purchase" value="Doc Date" disabled="disabled"/></td>
    <td><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="cashttdate" onfocus="load_calader('cashttdate');"/ id="cashttdate" size="10" onkeypress="keyset('chqdate',event);" onfocus="load_calader('cashttdate')"  value=""    />
    </font></font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="text"  class="label_purchase" value="Credit Account" disabled="disabled"/></td>
    <td><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="accno2" id="accno2" size="10" onkeypress="keyset('chqdate',event);"  value="120101"    />
    </font></font></td>
    <td colspan="2"><font color="#FFFFFF"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" size="10" id="acc_name2" name="acc_name2" onkeypress="keyset('bank',event);" value="Return Cheque" />
    </font></font></td>
	...
	window.onload = function(){
      ...
      <tr>
        <td colspan="5"><div class="CSSTableGenerator" id="chq_table" >
          <table width="71%">
              <tr>
                <td width="10%"   background="" ><font color="#FFFFFF">Cheque No</font></td>
                <td width="10%"  background=""><font color="#FFFFFF">Cheque Date</font></td>
                <td width="10%"  background=""><font color="#FFFFFF">Bank</font></td>
