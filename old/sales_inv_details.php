...
<form name="form1" id="form1"> <input type="hidden" name="cmd_new" id="cmd_new" value="1" />
  ...
  <tr>
    ...
    <td width="10%">
      <input type="button" name="searchinv" onclick="load_ord_lst();" id="searchinv" value="ORD" class="btn_purchase1" />
    ...
    <td width="10%"><input type="text" size="20" name="invdate" id="invdate" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('invdate');" class="text_purchase3" disabled="disabled"/></td>
    <td width="10%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input type="hidden" name="txtad" id="txtad" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);"   />
      <input type="text" name="txtreturn" id="txtreturn" value="0" class="text_purchase3" disabled="disabled" onkeypress="keyset('searchcust',event);"   /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" name="over60" id="over60" disabled="disabled" class="text_purchase3"/></td>
    <td><input type="text" name="Result" id="Result" disabled="disabled" class="text_purchase3"/></td>
    <td><input type="text"  class="label_purchase" value="Balance With Tmp Limit" disabled="disabled"/></td>
    <td><input type="text" name="crebal" id="crebal" class="text_purchase3" disabled="disabled"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="text" size="5" name="discount_org1" id="discount_org1" value="0" onkeyup="calc1_table_discount1();" onkeydown="calc1_table_discount1();" onkeypress="keyset('discount_org2',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 2" disabled="disabled"/></td>
    <td><input type="text" size="5" name="discount_org2" id="discount_org2" value="0"  onkeyup="calc1_table_discount1();" onkeydown="calc1_table_discount1();"  onkeypress="keyset('discount_org3',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 3" disabled="disabled"/></td>
    <td><input type="text" size="5" name="discount_org3" id="discount_org3" value="0" onkeypress="keyset('searchitem',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  <td><input type="text" disabled="disabled" value="Print WO Discount" class="label_purchase"></td>
  <td><input type="checkbox" id="promotion">
</td>
