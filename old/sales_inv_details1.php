...
<form name="form1" id="form1"> <input type="hidden" name="cmd_new" id="cmd_new" value="1" />
  ...
  <tr>
    ...
    <td width="10%">
      <input type="button" name="searchinv" onclick="load_ord_lst();" id="searchinv" value="..." class="btn_purchase1" />
    </td>
  ...
  <tr>
    ...
    <td><input type="text" size="5" name="discount_org1" id="discount_org1" value="0" onkeypress="keyset('discount_org2',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 2" disabled="disabled"/></td>
    <td><input type="text" size="5" name="discount_org2" id="discount_org2" value="0" onkeypress="keyset('discount_org3',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
