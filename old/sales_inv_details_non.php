...
<form name="form1" id="form1"> <input type="hidden" name="cmd_new" id="cmd_new" value="1" />
  ...
  <tr>
    ...
    <td width="10%"><input type="text" size="20" name="invdate" id="invdate" disabled="disabled" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('invdate');" class="text_purchase3"/></td>
    <td width="10%">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text"  class="text_purchase" name="invno" id="invno"/>
      <a href="serach_inv_non.php?stname=inv_mast_non" onClick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onFocus="this.blur()">
      <input type="button" name="searchcust2" id="searchcust2" value="..."  class="btn_purchase" />
      <input type="hidden" name="txtdono" id="txtdono" />
      </a></td>
    <td><input type="hidden" name="over60" id="over60" disabled="disabled" /></td>
    <td>&nbsp;</td>
    <td><input type="hidden"  class="label_purchase" value="Balance With Tmp Limit" disabled="disabled"/></td>
    <td><input type="hidden" name="crebal" id="crebal" disabled="disabled" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><input type="text"  class="label_purchase" value="Customer" disabled/></td>
    <td colspan="3"><input type="text"  class="text_purchase1"  name="firstname_hidden" id="firstname_hidden" onblur="custno_ind('')" onkeypress="keyset('department',event);" value="SCRP"/>
      <input type="text" class="text_purchase2" id="firstname" name="firstname" value="SCRAP SALES REGISRTY" />
      <a href="" onClick="NewWindow('serach_customer.php','mywin','800','700','yes','center');return false" onFocus="this.blur()">
        <input type="button" name="searchcust" id="searchcust" value="..."  class="btn_purchase" disabled="disabled">
      </a></td>
  ...
  <tr>
    ...
    <td><select name="brand" id="brand" onkeypress="keyset('searchitem',event);" class="text_purchase3"  onchange="setord();" disabled="disabled">
    	<option selected="selected" value='NON STOCK'>NON STOCK</option>
      <?php
  ...
  <tr>
    <td><input type="hidden"  class="label_purchase" value="VAT No" disabled="disabled"/></td>
    <td><input type="hidden" size="20" name="vat1" id="vat1" value="" onkeypress="keyset('vat2',event);" class="text_purchase3"/></td>
    <td><input type="hidden" size="20" name="vat2" id="vat2" value="" onkeypress="keyset('salesrep',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
    <td><label>
      <input type="hidden" name="vatgroup" value="vat" id="vatgroup_0"  onclick="calc1_table_discount1();" />
    </label></td>
    <td><label>
      <input type="hidden" name="vatgroup" value="non" id="vatgroup_1"  onclick="calc1_table_discount1();" />
    </label></td>
    <td><label>
      <input type="hidden" name="vatgroup" value="svat" id="vatgroup_2"  onclick="calc1_table_discount1();" />
    </label></td>
    <td><label>
      <input type="hidden" name="vatgroup" value="evat" id="vatgroup_3"  onclick="calc1_table_discount1();" />
    </label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<fieldset>               
  ...
  <tr>
    ...
    <div id="test"><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" name="itemd_hidden" id="itemd_hidden" size="10" onkeypress="keyset('qty',event);"  value="NS001"   />
    </font></div>  </font></td>
    ...
    <td><font color="#FFFFFF">
      <input type="text"  class="text_purchase3" id="itemd" name="itemd" onkeypress="keyset('rate',event);" value="NON STOCK ITEM" />
...
<table>
  ...
  <tr>
    <td><span class="style1">
      <input type="hidden"  class="label_purchase" value="Stock Level" disabled="disabled"/>
    </span></td>
    <td>&nbsp;</td>
    <td><input type="hidden" size="5" name="stklevel" id="stklevel" value="" class="text_purchase1"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><span class="style1">
      <input type="text"  class="label_purchase" value="Sub Total" disabled="disabled"/>
  ...
  <tr>
    <td><span class="style1">
      <input type="hidden"  class="label_purchase" value="Credit Period" disabled="disabled"/>
    </span></td>
    <td>&nbsp;</td>
    <td><input type="hidden" size="5" name="credper" id="credper" value=""  class="text_purchase1"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><span class="style1">
      <input type="text"  class="label_purchase" value="Discount" disabled="disabled"/>
