...
<form name="form1" id="form1"> <input type="hidden" name="cmd_new" id="cmd_new" value="1" />
  ...
  <tr>
    ...
    <td width="10%"><input type="text" name="salesord1" disabled id="salesord1" value="" class="text_purchase3" onkeypress="keyset('searchcust',event);"   />     </td>
    <td width="10%">
    ...
    <td width="10%"><input type="text" size="20" name="invdate" disabled id="invdate" value="<?php echo date("Y-m-d"); ?>"  onfocus="load_calader('invdate');" class="text_purchase3"/></td>
    <td width="10%">&nbsp;</td>
  </tr>
    <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><input type="text"  class="label_purchase" value="Online Order No" disabled="disabled"/></td>

                <td><input type="text" name="salesord2" disabled id="salesord2" value="" class="text_purchase3" onkeypress="keyset('searchcust', event);"   /> </td>
                <td><input type="button" name="searchinv1" onclick="load_ord_lst1();"  id="searchinv1" value="..." class="btn_purchase1" /> </td>
                <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="3"><input type="text"  class="text_purchase1" name="firstname_hidden" id="firstname_hidden" onblur="custno_ind('');" onkeypress="keyset('department',event);"/>
      ...
      <a href="" onClick="NewWindow('serach_customer.php?stname=sales_order','mywin','800','700','yes','center');return false" onFocus="this.blur()">
  ...
  <tr>
    ...
    <td style="visibility: hidden;"  id="tbrchecklbl" >
       
      <label >
      <input type="checkbox" name="tbrcheck" onClick="tbrsession();" id="tbrcheck" />
      <b>TBR Only</b></label></td>
  </tr>
  <tr>
    <td><input type="text"  class="label_purchase" value="VAT No" disabled="disabled"/></td>
    <td><input type="text" size="20" name="vat1" id="vat1" value=""  disabled onkeypress="keyset('vat2',event);" class="text_purchase3"/></td>
    <td><input type="text" size="20" name="vat2" id="vat2" value="" disabled onkeypress="keyset('salesrep',event);" class="text_purchase3"/></td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" size="5" name="discount_org1" id="discount_org1" onkeyup="calc1_table_discount1();" onkeydown="calc1_table_discount1();" onkeypress="keyset('discount_org2',event);" onblur="calc1_table_discount1();" class="text_purchase"/></td>
    <td><input type="text"  class="label_purchase" value="Discount 2" disabled="disabled" /></td>
    <td><input type="text" size="5" name="discount_org2" id="discount_org2" onkeyup="calc1_table_discount1();" onkeydown="calc1_table_discount1();" onkeypress="keyset('itemd_hidden',event);" onblur="calc1_table_discount2();" class="text_purchase"/></td>
...
<fieldset>               
  ...
  <tr>
    ...
    <td><a href="serach_item.php?stname=sales_order" onclick="NewWindow(this.href,'mywin','800','700','yes','center');return false" onfocus="this.blur()">
...
<table>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><input type="text"  size="15" class="text_purchase1" value="" id="txtinvt" name="txtinvt"/></td>
