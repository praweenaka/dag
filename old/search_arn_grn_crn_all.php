...
<tr>
					<?php 
	  				$stname = $_GET["stname"];
					?>
                             <td width="122"  background="" ><input type="text" size="20" name="cusno" id="cusno" value="" class="txtbox" onkeyup="<?php	echo "update_cust_list('$stname')"; ?>"/></td>
      <td width="603"  background="" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
                ...
                <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							$sql="select REFNO , SDATE, BALANCE, SAL_EX  from c_bal where Cancell='0' and BALANCE>0 and CUSCODE = '".$_SESSION['uti_cus_code']."' and trn_type!='ARN' and SDATE>'2016-12-31' and active <> '2' and block='0' ORDER BY SDATE desc limit 100";
