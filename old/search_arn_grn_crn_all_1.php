...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                ...
                $sql = "select REFNO , SDATE, BALANCE, SAL_EX  from c_bal where Cancell='0' and BALANCE>0 and CUSCODE = '" . $_SESSION['uti_cus_code'] . "' and trn_type!='ARN'  and active <> '2' and block='0' ORDER BY SDATE desc limit 200";
