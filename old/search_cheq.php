...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="JavaScript" src="js/search_cheq.js"></script>
        <style type="text/css">
    ...
    <body>
        ...
        <table width="1444" border="0">
            ...
            <tr>
                <td  background="images/headingbg.gif" ><input type="radio" name="radio" id="Option1" value="Option1" checked="checked" onclick="select_list('all');" />Save</td>
                <td  background="images/headingbg.gif" ><input type="radio" name="radio" id="Option2" value="Option2"  onclick="select_list('all');" />Not Approved</td>
                <td  background="images/headingbg.gif" ><input type="radio" name="radio" id="Option3" value="Option3" onclick="select_list('all');" />Not Posted</td>
                <td  background="images/headingbg.gif" ><input type="radio" name="radio" id="Option4" value="Option4"  onclick="select_list('all');" />Complete</td>
            </tr>
            <tr>					
                <?php
                $stname = $_GET["stname"];
                ?>
                <td width="283"  background="images/headingbg.gif" ><input type="text" size="20" name="invno" id="invno" value="" class="txtbox"  onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
                <td width="170"  background="images/headingbg.gif" >&nbsp;</td>
                <td width="264"  background="images/headingbg.gif" ><input type="hidden" size="10" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
                <td width="709"  background="images/headingbg.gif" ><input type="hidden" size="29" name="invdate" id="invdate" value="" class="txtbox" onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
            </tr>  </table>    
        <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                ...
                if ($_SESSION["txt_cuscode"] != "") {
                    $sql = "select * from s_invcheq where cus_code='" . $_SESSION["txt_cuscode"] . "'  ORDER BY che_date desc limit 50";
                } else {
                    $sql = "select * from s_invcheq  ORDER BY che_date desc limit 50";
                }
//                echo $sql;
