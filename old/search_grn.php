...
<tr>					
	  				...
	  				$stname = $_GET["stname"];
					?>
                             <td width="175"  background="images/headingbg.gif" ><input type="text" size="20" name="invno" id="invno" value="" class="txtbox"  onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
    ...
    <td width="346"  background="images/headingbg.gif" ><input type="text" size="50" name="invdate" id="invdate" value="" class="txtbox"/></td>
                             
   </tr>  </table>    
                <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                            <tr>
                              <td width="100"  background="images/headingbg.gif" ><font color="#FFFFFF">GIN No</font></td>
                              <td width="100"  background="images/headingbg.gif"><font color="#FFFFFF">GIN Date</font></td>
