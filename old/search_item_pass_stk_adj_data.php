...
if ($_GET["Command"]=="pass_stk_adj"){
	...
	echo "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n";
			...
			$sql=mysqli_query($GLOBALS['dbinv'],"Select * from inreq_mas where refno='".$_GET['refno']."'")or die(mysqli_error());
			if($row = mysqli_fetch_array($sql)){		
				...
				$sql1=mysqli_query($GLOBALS['dbinv'],"Select * from inreq_trn where refno='".$row['refno']."'")or die(mysqli_error());
