      ...
      <td width="603"  background="images/headingbg.gif" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
                ...
                <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                            <tr>
                              ...
                              <td width="424"  background="images/headingbg.gif"><font color="#FFFFFF">Details</font></td>
							...
							$sql="Select refno, bdate, details from ledmas  ORDER BY refno limit 50";
							...
							echo "<tr>               
                              <td onclick=\"journal('$cuscode', '$stname');\">".$row['refno']."</a></td>
                              <td onclick=\"journal('$cuscode', '$stname');\">".$row['bdate']."</a></td>
							   <td onclick=\"journal('$cuscode', '$stname');\">".$row['details']."</a></td>
