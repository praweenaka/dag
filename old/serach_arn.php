...
<tr>					
      ...
      <td width="603"  background="" ><input type="text" size="29" name="invdate" id="invdate" value="" onkeyup="<?php echo "update_list('$stname')"; ?>" class="txtbox"/></td>
                ...
                <div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
                            <tr>
							 ...
							 <td width="121"  background=""><font color="#FFFFFF">SDATE</font></td></tr>
                            <?php 
						...
						if ($_GET["mstatus"]!="gin"){	
							...
							echo "<tr>               
                              <td onclick=\"arnno('".$row['REFNO']."');\">".$row['REFNO']."</a></td>";
							 	...
							 	echo "<td onclick=\"arnno('".$row['REFNO']."');\">".$row['LCNO']."</a></td>";
