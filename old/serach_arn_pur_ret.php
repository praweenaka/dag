...
<script language="JavaScript" src="js/arn_pur_ret.js"></script>
...
<tr>					
					<?php 
	  				$stname = $_GET["stname"];
					?>
                             <td width="323"  background="images/headingbg.gif" ><input type="text" size="20" name="invno" id="invno" value="" class="txtbox"  onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
    <td width="457"  background="images/headingbg.gif" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
...
<div class="CSSTableGenerator" id="filt_table">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							$sql="SELECT * FROM s_purmas where CANCEL!='1' order by SDATE desc";
