...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="JavaScript" src="js/inv.js?v1"></script>
        <style type="text/css">
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                ...
                //$sql = "SELECT * from vendor where CAT<>'X' order by CODE limit 50";   //- new sub table
                if (($_SESSION["CURRENT_USER"] == 'sarath' or $_SESSION["CURRENT_USER"] == 'SARATH') and $_GET['stname'] == "item_claim") {
                    ...
                    $sql = "SELECT * from view_vendor where CAT<>'X' order by CODE,id limit 50";
                }
