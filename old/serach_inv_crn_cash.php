...
//if ($_GET["stname"]=="crn"){
                    ...
                    if ($_SESSION["MonthView1"] != "") {
                        ...
                        $sql = "select REF_NO , SDATE, GRAND_TOT, TOTPAY  from s_salma where Accname != 'NON STOCK' and CANCELL='0' and C_CODE='" . $_SESSION["suppno"] . "' and year(SDATE)='" . $year . "' and month(SDATE)='" . $month . "' ORDER BY SDATE desc limit 150";
                        //echo $sql;
