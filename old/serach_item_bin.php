    ...
    <body>
        ...
        <table width="735" border="0" class=\"form-matrix-table\">
            ...
            <tr>
                ...
                <td  background="images/headingbg.gif" ><input type="checkbox" name="checkbox" id="checkbox" onclick="update_item_list();" />Stock Item Only</td>
                <tr>
                    <td width="30" background="images/headingbg.gif"><input type="text" disabled="disabled" value="Brand" class="label_purchase"></td>
                    <td background="images/headingbg.gif">
                        <select onchange="update_item_list();" class="text_purchase3" onkeypress="keyset('searchitem', event);" id="brand" name="brand">
