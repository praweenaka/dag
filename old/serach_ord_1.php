...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <table width="810" border="0" class=\"form-matrix-table\">
            ...
            <tr>
                <td  background="" ><input type="radio" name="radio" id="Option5" value="Option1" checked="checked" onclick="update_list('$stname');" />
                    Pending</td>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
                ...
                //} else {
                $sql = "SELECT * FROM s_quomas1 where ord_no ='0' order by sal_ex desc limit 50";
                //}
