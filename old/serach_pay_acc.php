...
<script language="JavaScript" src="js/cash_pay_acc.js"></script>
<style type="text/css">
...
<tr>					
    ...
    <td width="243"  background="images/headingbg.gif" >
    <td width="122"  background="images/headingbg.gif" >&nbsp;</td>
    </td>
...
<tr>
                              ...
                              <td width="177"  background="images/headingbg.gif"><font color="#FFFFFF">Cheque No</font></td>
                              <td width="177"  background="images/headingbg.gif"><font color="#FFFFFF">Name</font></td>
							...
							$sql="select refno, bdate, cheno, name, amount  from paymas where type = 'C' and cancel!='1' order by bdate limit 50";
