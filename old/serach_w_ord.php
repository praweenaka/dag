...
<script language="JavaScript" src="js/customer_ord.js"></script>
<style type="text/css">
...
<tr>					
      ...
      <td width="433" colspan="2"  background="images/headingbg.gif" ><input type="text" size="70" name="customername" id="customername" value="" class="txtbox" onkeyup="<?php echo "update_list('$stname')"; ?>"/></td>
...
<div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
							...
							//if ($_GET["stname"]=="ord"){
								$sql="SELECT * FROM s_wcusordmas where CANCELL='0' and SAL_EX='".$_SESSION["salrep"]."' order by SDATE desc limit 50";
							//} else {
							//	$sql="SELECT * FROM s_cusordmas where INVNO='0' and CANCELL='0' order by SDATE desc limit 50";
							//}
