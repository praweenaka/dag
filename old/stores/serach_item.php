...
<tr>
  ...
  <td  background="images/headingbg.gif" >
  <?php
...
<?php
 if ($_GET["stname"]==""){
                             echo "<td width=\"122\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"20\" name=\"itno\" id=\"itno\" value=\"\" class=\"txtbox\" onkeyup=\"update_item_list();\"/></td>
      <td width=\"603\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"70\" name=\"itemname\" id=\"itemname\" value=\"\" class=\"txtbox\" onkeyup=\"update_item_list_ord();\"/></td>";
	} else {
		                       echo "<td width=\"122\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"20\" name=\"itno\" id=\"itno\" value=\"\" class=\"txtbox\" onkeyup=\"update_item_list('".$_GET["stname"]."');\"/></td>
      <td width=\"603\"  background=\"images/headingbg.gif\" ><input type=\"text\" size=\"70\" name=\"itemname\" id=\"itemname\" value=\"\" class=\"txtbox\" onkeyup=\"update_item_list('".$_GET["stname"]."');\"/></td>";
	}  
	?>  
      </table>    
<div id="filt_table" class="CSSTableGenerator">  <table width="735" border="0" class=\"form-matrix-table\">
						...
						if ($_GET["stname"]=="claim_item"){
							...
							echo "<tr>               
							  ...
							  <td onclick=\"itno_claim('".$row['STK_NO']."', '".$_GET["stname"]."');\">".$row['QTYINHAND']."</a></td>";
							...
							echo "<tr>               
                              ...
                              <td onclick=\"itno('".$row['STK_NO']."', '".$_GET["stname"]."');\">".$row['DESCRIPT']."</td>
