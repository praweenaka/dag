...
<fieldset>
                                                	<legend>
  <div class="text_forheader">Enter Un Delivered Invoice Details</div>
                                               	 </legend>             
...
<form name="form1" id="form1">            
  ...
  <tr>
    ...
    <td colspan="3"><input type="text" class="text_purchase2" name="refno" id="refno"  onkeypress="keyset('itemd_hidden',event);"/></td>
    <td><a onclick="load_inv();" class="btn_purchase">Get Inv.</a></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
