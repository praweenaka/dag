            ...
            <div class="col-md-6">
                ...
                <div class="form-group"> 
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#menu1"  >SPARE ITEM</a></li>
                  ...
                  <div id="home" class="tab-pane fade in active"> 
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" placeholder="Margin" id="w_margin"   class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" placeholder="Margin" id="r_margin"   class="form-control">
                            </div>
                        </div> 
                        <div class="form-group">
                      ...
                      <table width="100%" class="table table-striped table-bordered table-hover">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td><input type="number" placeholder="COST" id="cost"   class="form-control"></td>
