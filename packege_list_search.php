...
<head>
    ...
    <script language="JavaScript" src="js/packege_list.js"></script> 
...
<body>
    ...
    <div id="filt_table" class="CSSTableGenerator container"> 
        <table id="testTable"  class="table table-bordered">
            ...
            $sql2 = "SELECT * from packegelist where cancel='0' ";
            ...
            foreach ($conn->query($sql2) as $row) { 
                $cuscode = $row['code']; 
                echo "<tr>               
                <td onclick=\"custno('$cuscode', '$stname');\">" . $row['size'] . "</a></td>
                <td onclick=\"custno('$cuscode', '$stname');\">" . $row['design'] . "</a></td>
