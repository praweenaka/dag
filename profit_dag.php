...
<section class="content" onload="search1();">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">VIEW  DAG PROFIT REPORT</h3>
        </div>
        <form role="form" class="form-horizontal">
            <div class="box-body"> 
                ...
                <tbody>
                    ...
                    $sql = "select * from dag_item  where (flag ='2' or flag ='7') ";
                        ...
                        <tr>
                           ...
                           <?php  if($row['flag']=='7'){
                            ...
                            <?php
                             ...
                             if($row['cancel']=='0'){
                                 if($row['flag']=='2'){
                                     $pro=$row['total']-$row['cost'];
                                       echo "<td style='background-color:yellow'> " . number_format($pro,2) . " </td>"; 
                                     echo "<td style='background-color:#1ef51e'>COMPLETE</td>"; 
                                }else if($row['flag']=='7'){
                                    $pro=$row['total1']-$row['cost'];
                                       echo "<td style='background-color:yellow'>" . number_format($pro,2) . " </td>"; 
...
<script>
    ...
    function name(subNode) {
        ...
        document.getElementById("cusname").value=cell_4;
         ...
         document.getElementById("totalamou").value=cell_10; 
